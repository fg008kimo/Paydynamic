...
void TxnParByUsOTM(char    cdebug)
{
        cDebug = cdebug;
}
...
ERRLOG("TxnParByUsOTM::Authorize::txn_seq not found!!\n");
		iRet=INT_ERR; 
...
ERRLOG("TxnParByUsOTM::Authorize::merchant_id not found!!\n");
...
ERRLOG("TxnParByUsOTM::Authorize::service_code not found!!\n");
...
ERRLOG("TxnParByUsOTM::Authorize::ccy not found!!\n");
...
ERRLOG("TxnParByUsOTM::Authorize::dst_ccy not found!!\n");
		iRet=INT_CURRENCY_CODE_NOT_FOUND;
		PutField_Int(hContext,"internal_error",iRet);
	}
...
ERRLOG("TxnParByUsOTM:Authorize::invalid service code [%s]\n",csServiceCode);
...
ERRLOG("TxnParByUsOTM::Authorize::txn_amt not found!!\n");
...
ERRLOG("TxnParByUsOTM:Authorize::GetExchangeInfo Error\n");
                }
	}
...
ERRLOG("TxnParByUsOTM::BOFee::GetTxnFee Failed Ret [%d]\n", iRet);
			iRet = INT_ERR;
		}
		else {
...
ERRLOG("TxnMgtByUsMTO::BOParADjustment::ProcesspartyBalance Failed Ret [%d]\n", iRet);
                } else {
...
ERRLOG("TxnMgtByUsMTO::BOParADjustment::ProcesspartyBalance Failed to get dc_ind\n");
                                iRet = PD_ERR;
                        }
...
DEBUGLOG(("TxnParByUsOTM Normal Exit() iRet = [%d]\n",iRet));
	return iRet;
}
