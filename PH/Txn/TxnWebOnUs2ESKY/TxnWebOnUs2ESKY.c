...
-------------------------------                    ------------            --------------
Init Version                                       2011/01/10              Cody Chan
*/
...
void TxnWebOnUs2ESKY(char    cdebug)
{
        cDebug = cdebug;
}

int     AddESKYTxnLog(hash_t *hContext,
...
{
	int iRet = PD_OK;
	iRet = AddESKYTxnLog(hContext,hRequest);
	return iRet;
}
