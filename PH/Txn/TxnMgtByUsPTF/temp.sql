select * from txn_code where tc_code = 'PTO'
...
values ('PTF', '0000', '000000', 'PSP Balance Transfer From',
...
insert into txn_code (tc_code, tc_process_type, tc_process_code, tc_desc,
                        tc_create_user, tc_create_timestamp, tc_update_user, tc_update_timestamp,
                        tc_voidable, tc_fe_display)
values ('PTT', '0000', '000000', 'PSP Balance Transfer To',
        'SYSTEM', sysdate, 'SYSTEM', sysdate,
        0, 1);        
        

select * from txn_supported where ts_txn_code = 'PTO'
...
select * from channel_txn_map where ct_txn_code = 'PTO'
...
select * from def_txn_status_map where dm_txn_code = 'PTO';
...
select dm_type, dm_status, dm_ar_ind, 'PTF', dm_status_desc, 'SYSTEM', sysdate, 'SYSTEM', sysdate
from   def_txn_status_map where dm_txn_code = 'PTO';

insert into def_txn_status_map (dm_type, dm_status, dm_ar_ind, dm_txn_code, dm_status_desc, dm_create_user, dm_create_timestamp, dm_update_user, dm_update_timestamp)
select dm_type, dm_status, dm_ar_ind, 'PTT', dm_status_desc, 'SYSTEM', sysdate, 'SYSTEM', sysdate
from   def_txn_status_map where dm_txn_code = 'PTO';
