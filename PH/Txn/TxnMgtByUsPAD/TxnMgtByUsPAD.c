...
ERRLOG("TxnMgtByUsPAD::Authorize::txn_code not found!!\n");
                iRet=INT_ERR;
...
ERRLOG("TxnMgtByUsPAD::BOFee::GetTxnFee Failed Ret [%d]\n", iRet);
                        iRet = INT_ERR;
                }
                else {
...
ERRLOG("TxnMgtByUsPAD::BOADjustment::ProcesspartyBalance Failed to get dc_ind\n");
                                iRet = PD_ERR;
                        }
