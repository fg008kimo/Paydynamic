...
void TxnParByUsMAD(char    cdebug)
{
        cDebug = cdebug;
}
...
ERRLOG("TxnParByUsMAD::Authorize::txnid not found!!\n");
...
ERRLOG("TxnParByUsMAD::Authorize::txn_code not found!!\n");
                iRet=INT_ERR;
...
ERRLOG("TxnParByUsMAD::Authorize::merchant_id not found!!\n");
...
ERRLOG("TxnParByUsMAD::Authorize::code not found!!\n");
                        iRet=INT_CODE_ERROR;
                	PutField_Int(hContext,"internal_error",iRet);
	}
...
ERRLOG("TxnParByUsMAD::Authorize::serivce_code not found!!\n");
...
ERRLOG("TxnParByUsMAD:Authorize::invalid service code [%s]\n",csService);
...
ERRLOG("TxnParByUsMAD::Authorize::ccy not found!!\n");
...
ERRLOG("TxnParByUsMAD::Authorize::txn_amt not found!!\n");
...
ERRLOG("TxnParByUsMAD::Authorize::approval_date not found!!\n");
                        iRet=INT_INVALID_TXN;
...
ERRLOG("TxnParByUsMAD::BOFee::GetTxnFee Failed Ret [%d]\n", iRet);
			iRet = INT_ERR;
                } 	
		else {
...
ERRLOG("TxnParByUsMAD::BOParADjustment::ProcesspartyBalance Failed Ret [%d]\n", iRet);
		} else {	
...
ERRLOG("TxnParByUsMAD::BOParADjustment::ProcesspartyBalance Failed to get dc_ind\n");
				iRet = PD_ERR;
			}
...
DEBUGLOG(("TxnParByUsMAD Normal Exit() iRet = [%d]\n",iRet));
        return iRet;
}
