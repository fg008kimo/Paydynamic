...
-------------------------------                    ------------            --------------
Init Version                                       2011/10/20              Cody Chan
*/
...
void TxnWebOnUs2YPY(char    cdebug)
{
        cDebug = cdebug;
}

int     AddYPYTxnLog(hash_t *hContext,
...
{
	int iRet = PD_OK;
	iRet = AddYPYTxnLog(hContext,hRequest);
	return iRet;
}
