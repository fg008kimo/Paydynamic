...
-------------------------------                    ------------            --------------
Init Version                                       2011/02/21              Cody Chan
*/
...
void TxnWebOnUs2LKP(char    cdebug)
{
        cDebug = cdebug;
}

int     AddLKPTxnLog(hash_t *hContext,
...
{
	int iRet = PD_OK;
	iRet = AddLKPTxnLog(hContext,hRequest);
	return iRet;
}
