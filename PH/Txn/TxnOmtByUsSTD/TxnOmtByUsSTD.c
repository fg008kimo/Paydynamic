...
ERRLOG("TxnOmtByUsSTD:Authorize::receive_ccy and receive_amt should exists in a pair!!\n");
                }
...
ERRLOG("TxnOmtByUsSTD::Authorize() receive_amt Invalid\n");
