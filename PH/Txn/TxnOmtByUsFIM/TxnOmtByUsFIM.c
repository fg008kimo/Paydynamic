...
void TxnOmtByUsFIM(char	cdebug)
{
	cDebug = cdebug;
}
...
ERRLOG("TxnOmtByUsFIM::Authorize::merchant_id not found!!\n");
...
ERRLOG("TxnOmtByUsFIM::Authorize::service_code not found!!\n");
...
ERRLOG("TxnOmtByUsFIM::Authorize::ccy not found!!\n");
...
ERRLOG("TxnOmtByUsFIM::Authorize::dst_ccy not found!!\n");
		iRet=INT_CURRENCY_CODE_NOT_FOUND;
		PutField_Int(hContext,"internal_error",iRet);
	}
...
ERRLOG("TxnOmtByUsFIM:Authorize::invalid service code [%s]\n",csServiceCode);
...
ERRLOG("TxnOmtByUsFIM::Authorize::country not found!!\n");
...
ERRLOG("TxnOmtByUsFIM::Authorize::txn_amt not found!!\n");
...
ERRLOG("TxnOmtByUsFIM:Authorize::GetExchangeInfo Error\n");
		}
	}
...
ERRLOG("TxnOmtByUsFIM::BOFee::GetTxnFee Failed Ret [%d]\n", iRet);
			iRet = INT_ERR;
		}
		else {
...
DEBUGLOG(("Authorize::Call BOOLBalance: ProcessFundinPayout net_amt [%lf]\n", dTmp));
		}
	}
...
ERRLOG("TxnOmtByUsFIM:: Authorize() Call DBMiModeTxnCtl:GetMiModeTxnCtl() Failed!!\n");
                }
...
DEBUGLOG(("Authorize::TxnOmtByUsFIR DBOLTransaction->UpdateDetail Failed\n"));
				}
                        }
                }
	}
...
DEBUGLOG(("TxnOmtByUsFIM Normal Exit() iRet = [%d]\n",iRet));
	return iRet;
}
