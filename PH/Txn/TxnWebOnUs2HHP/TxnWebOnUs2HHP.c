...
void TxnWebOnUs2HHP(char    cdebug)
{
        cDebug = cdebug;
}

int     AddHHPTxnLog(hash_t *hContext,
...
{
	int iRet = PD_OK;
	iRet = AddHHPTxnLog(hContext,hRequest);
	return iRet;
}
