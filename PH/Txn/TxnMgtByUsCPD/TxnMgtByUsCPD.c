...
PRD332
 ...
 - Replace FindURL to FindServicePspUrl            2021/08/09              [ZBL]
*/
...
DEBUGLOG(("Authorize::Call TxnBeUrl:GetServiceCode\n"));
				...
				iDtlRet = (unsigned long)(*DBObjPtr)((const char*)csPspId, PD_INITIAL_TXN_CODE, rRecordSet);
...
DEBUGLOG(("- [%d] service_code = [%s]\n", iCnt, csServiceCode));
							...
							/*
						 	 ...
						 	 */
DEBUGLOG(("- [%d] Call ServicePspUrl:FindServicePspUrl\n", iCnt));
							DBObjPtr = CreateObj(DBPtr, "DBServicePspUrl", "FindServicePspUrl");
							iDtlRet = (unsigned long)(*DBObjPtr)((const unsigned char*)csServiceCode, (const unsigned char*)csPspId);
...
DEBUGLOG(("- [%d] Call ServicePspUrl:Delete\n", iCnt));
									...
									if ((unsigned long)((*DBObjPtr)((const char*)csPspId, (const char*)csServiceCode)) != PD_OK)
										iRet = INT_ERR;
...
DEBUGLOG(("- [%d] Call ServicePspUrl:FindServicePspUrl Error!!\n", iCnt));
ERRLOG("TxnMgtByUsCPD::Authorize:: Call ServicePspUrl:FindServicePspUrl Error!!\n");
