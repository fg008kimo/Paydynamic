...
void TxnMgtByUsOTP(char    cdebug)
{
        cDebug = cdebug;
}
...
ERRLOG("TxnMgtByUsOTP::Authorize::txnid not found!!\n");
...
ERRLOG("TxnMgtByUsOTP::Authorize::txn_code not found!!\n");
                iRet=INT_ERR;
...
ERRLOG("TxnMgtByUsOTP::Authorize::psp_id not found!!\n");
...
ERRLOG("TxnMgtByUsOTP::Authorize::txn_country not found!!\n");
...
ERRLOG("TxnMgtByUsOTP::Authorize::ccy not found!!\n");
...
ERRLOG("TxnMgtByUsOTP::Authorize::txn_amt not found!!\n");
...
ERRLOG("TxnMgtByUsOTP::Authorize::approval_date not found!!\n");
                        iRet=INT_INVALID_TXN;
			PutField_Int(hContext,"internal_error",iRet);
                }
                else {
...
DEBUGLOG(("Authorize::report_date = [%s]\n", csTmp));
	...
	PutField_Char(hContext, "dc_ind", PD_ADJ_TYPE_CREDIT);
...
ERRLOG("TxnMgtByUsOTP::BOFee::GetTxnFee Failed Ret [%d]\n", iRet);
                        iRet = INT_ERR;
                }
                else {
...
ERRLOG("TxnMgtByUsOTP::BOADjustment::ProcesspartyBalance Failed [%d]\n", iRet);
		} else {
...
ERRLOG("TxnMgtByUsOTP::BOADjustment::ProcesspartyBalance Failed to get dc_ind\n");
                                iRet = PD_ERR;
                        }
...
DEBUGLOG(("Authorize::Call DBTxnPspDetail:Add\n"));
		PutField_CString(hContext, "desc", "Othere System To Psp Balance Transfer");
...
DEBUGLOG(("TxnMgtByUsOTP Normal Exit() iRet = [%d]\n",iRet));
        return iRet;
}
