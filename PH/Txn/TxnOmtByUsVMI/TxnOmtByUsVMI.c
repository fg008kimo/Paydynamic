...
-------------------------------                    ------------            --------------
Init Version                                       2016/06/24              Elvis Wong
*/
...
void 	TxnOmtByUsVMI(char    cdebug)
{
        cDebug = cdebug;
}
...
ERRLOG("TxnOmtByUsVMI::Authorize::merchant_id not found!!\n");
...
ERRLOG("TxnOmtByUsVMI::Authorize::service_code not found!!\n");
...
ERRLOG("TxnOmtByUsVMI::Authorize::remark not found!!\n");
...
DEBUGLOG(("TxnOmtByUsVMI Normal Exit() iRet = [%d]\n",iRet));
	return iRet;
}
...
ERRLOG("TxnOmtByUsVMI:Authorize::GetTxnHeader::not found record!!\n");
                        iRet=INT_NOT_RECORD;
                }
...
ERRLOG("TxnOmtByUsVMI::GetTxnInfo::GetTxnDetail::not found record!!\n");
			iRet=INT_NOT_RECORD;
		}
...
ERRLOG("TxnOmtByUsVMI::GetTxnInfo::GetFeeChgDetailByType:: [%s] not found record for [%s]!!\n", PD_ELEMENT_TXN_AMT, csTxnSeq);
			iRet=INT_NOT_RECORD;
		}
