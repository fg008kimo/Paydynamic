...
ERRLOG("TxnOmtByUsOES:: Authorize() party_id NOT FOUND!!!\n");
        }
...
ERRLOG("TxnOmtByUsOES::Authorize() default NOT FOUND!!!\n");
        }
...
ERRLOG("TxnMgtByUsOES::Authorize::call BOEmailSetting::ProcessTpl Failed, iRet=%d\n", iRet);
                } else {
