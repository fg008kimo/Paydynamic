...
-------------------------------                    ------------            --------------
Init Version                                       2012/04/10              Cody Chan
*/
...
void TxnWebOnUs2SPY(char    cdebug)
{
        cDebug = cdebug;
}

int     AddSPYTxnLog(hash_t *hContext,
...
{
	int iRet = PD_OK;
	iRet = AddSPYTxnLog(hContext,hRequest);
	return iRet;
}
