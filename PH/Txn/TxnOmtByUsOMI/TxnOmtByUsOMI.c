...
-------------------------------                    ------------            --------------
Init Version                                       2014/01/27              Virginia Yun
*/
...
void TxnOmtByUsOMI(char    cdebug)
{
        cDebug = cdebug;
}
...
ERRLOG("TxnOmtByUsOMI::Authorize::txn_seq not found!!\n");
		iRet=INT_ERR; 
...
ERRLOG("TxnOmtByUsOMI::Authorize::merchant_id not found!!\n");
...
ERRLOG("TxnOmtByUsOMI::Authorize::service_code not found!!\n");
...
ERRLOG("TxnOmtByUsOMI::Authorize::ccy not found!!\n");
...
ERRLOG("TxnOmtByUsOMI::Authorize::dst_ccy not found!!\n");
		iRet=INT_CURRENCY_CODE_NOT_FOUND;
		PutField_Int(hContext,"internal_error",iRet);
	}
...
ERRLOG("TxnOmtByUsOMI::Authorize::country not found!!\n");
...
ERRLOG("TxnOmtByUsOMI::Authorize::txn_amt not found!!\n");
...
ERRLOG("TxnOmtByUsOMI:Authorize::GetExchangeInfo Error\n");
                }
	}
...
ERRLOG("TxnOmtByUsOMI::BOFee::GetTxnFee Failed Ret [%d]\n", iRet);
			iRet = INT_ERR;
		}
		else {
...
ERRLOG("TxnMgtByUsOMI::BOOLADjustment::ProcesspartyBalance Failed Ret [%d]\n", iRet);
                } else {
...
ERRLOG("TxnMgtByUsOMI::BOOLADjustment::ProcesspartyBalance Failed to get dc_ind\n");
                                iRet = PD_ERR;
                        }
...
DEBUGLOG(("Authorize::Call BOOLTxnElements:AddTxnAmtElement\n"));
	...
	if (iRet == PD_OK) {
		...
		if (dMarkupAmt > 0.0)  {
DEBUGLOG(("Authorize::Call BOOLTxnElements:AddMarkupAmtElement\n"));
...
DEBUGLOG(("TxnOmtByUsOMI Normal Exit() iRet = [%d]\n",iRet));
	return iRet;
}
