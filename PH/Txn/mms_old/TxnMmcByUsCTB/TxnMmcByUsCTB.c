...
void TxnMmcByUsCTB(char    cdebug)
{
	cDebug = cdebug;
}
...
ERRLOG("TxnMmcByUsCTB::Authorize::txnid not found!!\n");
...
ERRLOG("TxnMmcByUsCTB::Authorize::dtl_txnid not found!!\n");
                iRet=INT_INVALID_TXN;
	}
*/
...
DEBUGLOG(("Authorize::bank_id = [%s]\n",csTmp));
		...
		PutField_CString(hTxn,"dst_party_type",PD_MMS_PARTY_BANK);
        }
...
ERRLOG("TxnMmcByUsCTB::Authorize::txn_amt not found!!\n");
...
ERRLOG("TxnMmcByUsCTB::Authorize::ccy not found!!\n");
...
ERRLOG("TxnMmcByUsCTB::Authorize::bank_charge_refund not found!!\n");
        }
*/
...
ERRLOG("TxnMmcByUsCTB::Authorize::from_node not found!!\n");
                iRet = PD_ERR;
                PutField_Int(hContext,"internal_error",iRet);
                }
...
ERRLOG("TxnMmcByUsCTB::Authorize::to_node not found!!\n");
                iRet = PD_ERR;
                PutField_Int(hContext,"internal_error",iRet);
                }
        }
...
ERRLOG("TxnMmcByUsCTB::Authorize::server node_id not found!!\n");
                iRet = INT_ERR;
...
ERRLOG("TxnMmcByUsCTB::Authorize::CTBHandler Failed\n");
                }
        }
...
ERRLOG("TxnMmcByUsCTB::Authorize::TxnTypeHandler Failed\n");
                        }
                        else {
			...
			PutField_CString(hTxn,"process_type", PD_MMS_PROCESS_TYPE);
                        PutField_CString(hTxn, "process_code", PD_MMS_TRANSFER_FR_MERCH);
...
ERRLOG("TxnMmcByUsCTB::Authorize::TxnMmsByUs2Node Failed\n");
                                                        }
                                                        else {
...
DEBUGLOG(("TxnMmcByUsCTB Normal Exit() iRet = [%d]\n",iRet));
	return iRet;
}
