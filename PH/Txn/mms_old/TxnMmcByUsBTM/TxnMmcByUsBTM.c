...
void TxnMmcByUsBTM(char    cdebug)
{
	cDebug = cdebug;
}
...
ERRLOG("TxnMmcByUsBTM::Authorize::txnid not found!!\n");
...
ERRLOG("TxnMmcByUsBTM::Authorize::dtl_txnid not found!!\n");
                iRet=INT_INVALID_TXN;
...
ERRLOG("TxnMmcByUsBTM::Authorize::txn_amt not found!!\n");
...
ERRLOG("TxnMmcByUsBTM::Authorize::ccy not found!!\n");
...
ERRLOG("TxnMmcByUsBTM::Authorize::bank_charge_refund not found!!\n");
        }
*/
...
ERRLOG("TxnMmcByUsBTM::Authorize::from_node not found!!\n");
                iRet = PD_ERR;
                PutField_Int(hContext,"internal_error",iRet);
                }
        }
...
ERRLOG("TxnMmcByUsBTM::Authorize::to_node not found!!\n");
                iRet = PD_ERR;
                PutField_Int(hContext,"internal_error",iRet);
                }
        }
...
DEBUGLOG(("Authorize::Call BOMmsBalance: TxnTypeHandler\n"));
		...
		if (iRet != PD_OK) {
DEBUGLOG(("Authorize::BTMHandler Failed\n"));
ERRLOG("TxnMmcByUsBTM::Authorize::BTMHandler Failed\n");
                }
        }
...
ERRLOG("TxnMmcByUsBTM::Authorize::TxnTypeHandler Failed\n");
                }
                else {
...
DEBUGLOG(("TxnMmcByUsBTM Normal Exit() iRet = [%d]\n",iRet));
	return iRet;
}
