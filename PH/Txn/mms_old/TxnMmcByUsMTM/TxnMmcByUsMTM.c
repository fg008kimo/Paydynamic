...
void TxnMmcByUsMTM(char    cdebug)
{
	cDebug = cdebug;
}
...
ERRLOG("TxnMmcByUsMTM::Authorize::txnid not found!!\n");
...
ERRLOG("TxnMmcByUsMTM::Authorize::dtl_txnid not found!!\n");
                iRet=INT_INVALID_TXN;
	}
*/
...
ERRLOG("TxnMmcByUsMTM::Authorize::txn_amt not found!!\n");
...
ERRLOG("TxnMmcByUsMTM::Authorize::ccy not found!!\n");
...
ERRLOG("TxnMmcByUsMTM::Authorize::bank_charge_refund not found!!\n");
        }
*/
...
ERRLOG("TxnMmcByUsMTM::Authorize::from_node not found!!\n");
                iRet = PD_ERR;
                PutField_Int(hContext,"internal_error",iRet);
                }
        }
...
ERRLOG("TxnMmcByUsMTM::Authorize::to_node not found!!\n");
                iRet = PD_ERR;
                PutField_Int(hContext,"internal_error",iRet);
                }
        }
...
ERRLOG("TxnMmcByUsMTM::Authorize::TxnTypeHandler Failed\n");
                }
                else {
...
DEBUGLOG(("TxnMmcByUsMTM Normal Exit() iRet = [%d]\n",iRet));
	return iRet;
}
