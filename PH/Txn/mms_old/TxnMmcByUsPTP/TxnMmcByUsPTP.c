...
ERRLOG("TxnMmcByUsPTP::Authorize::from_node not found!!\n");
                iRet = PD_ERR;
                PutField_Int(hContext,"internal_error",iRet);
                }
        }
...
ERRLOG("TxnMmcByUsPTP::Authorize::to_node not found!!\n");
                iRet = PD_ERR;
                PutField_Int(hContext,"internal_error",iRet);
                }
        }
...
ERRLOG("TxnMmcByUsPTP::Authorize::server node_id not found!!\n");
                iRet = INT_ERR;
...
DEBUGLOG(("Authorize::Unaccepted Node Id [%s]\n", csNodeId));
ERRLOG("TxnMmcByUsPTP::Authorize::Unaccepted Node Id [%s]\n", csNodeId);
			iRet = PD_ERR;
		}
		else {
...
ERRLOG("TxnMmcByUsPTP::Authorize::TxnMmsByUs2Node Failed\n");
                                                        }
                                                        else {
