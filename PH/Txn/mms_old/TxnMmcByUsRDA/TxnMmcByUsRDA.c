...
void TxnMmcByUsRDA(char    cdebug)
{
	cDebug = cdebug;
}
...
ERRLOG("TxnMmcByUsRDA::Authorize::txnid not found!!\n");
...
ERRLOG("TxnMmcByUsRDA::Authorize::dtl_txnid not found!!\n");
                iRet=INT_INVALID_TXN;
...
ERRLOG("TxnMmcByUsRDA::Authorize::current dtl_txnid not found!!\n");
                iRet=INT_INVALID_TXN;
...
ERRLOG("TxnMmcByUsRDA::Authorize::txn_amt not found!!\n");
...
ERRLOG("TxnMmcByUsRDA::Authorize::ccy not found!!\n");
...
//ERRLOG("TxnMmcByUsRDA::Authorize::processing_cost not found!!\n");
        }
...
//ERRLOG("TxnMmcByUsRDA::Authorize::bank_charge not found!!\n");
        }
...
//ERRLOG("TxnMmcByUsRDA::Authorize::bank_charge_refund not found!!\n");
        }
...
//ERRLOG("TxnMmcByUsRDA::Authorize::filing_num not found!!\n");
        }
...
ERRLOG("TxnMmcByUsRDA::Authorize::from_type not found!!\n");
		iRet=INT_ERR;
        }
...
ERRLOG("TxnMmcByUsRDA::Authorize::from_id not found!!\n");
		iRet=INT_ERR;
        }
*/
...
ERRLOG("TxnMmcByUsRDA::Authorize::to_type not found!!\n");
		iRet=INT_ERR;
        }
...
ERRLOG("TxnMmcByUsRDA::Authorize::to_id not found!!\n");
		iRet=INT_ERR;
	}
...
ERRLOG("TxnMmcByUsRDA::Authorize::not same service!!\n");
...
DEBUGLOG(("Authorize::%s = [%s]\n",csTag,csToTypeID));
		...
		PutField_CString(hContext, "to_node", csToNode);
		PutField_CString(hContext, "party_node_id", csToNode);
	}
...
DEBUGLOG(("TxnMmcByUsRDA Normal Exit() iRet = [%d]\n",iRet));
	return iRet;
}
