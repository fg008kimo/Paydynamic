...
void TxnMmcByUsCTC(char    cdebug)
{
	cDebug = cdebug;
}
...
ERRLOG("TxnMmcByUsCTC::Authorize::txnid not found!!\n");
...
ERRLOG("TxnMmcByUsCTC::Authorize::dtl_txnid not found!!\n");
                iRet=INT_INVALID_TXN;
	}
*/
...
ERRLOG("TxnMmcByUsCTC::Authorize::host_ref not found!!\n");
                iRet=INT_INVALID_TXN;
...
ERRLOG("TxnMmcByUsCTC::Authorize::host_dtl_ref not found!!\n");
                iRet=INT_INVALID_TXN;
...
ERRLOG("TxnMmcByUsCTC::Authorize::txn_amt not found!!\n");
...
ERRLOG("TxnMmcByUsCTC::Authorize::ccy not found!!\n");
...
ERRLOG("TxnMmcByUsCTC::Authorize::bank_charge_refund not found!!\n");
        }
*/
...
ERRLOG("TxnMmcByUsCTC::Authorize::from_node not found!!\n");
                iRet = PD_ERR;
                PutField_Int(hContext,"internal_error",iRet);
                }
...
ERRLOG("TxnMmcByUsCTC::Authorize::service_code not found!!\n");
			iRet = PD_ERR;
			PutField_Int(hContext,"internal_error",iRet);
		}
        }
...
ERRLOG("TxnMmcByUsCTC::Authorize::to_node not found!!\n");
                iRet = PD_ERR;
                PutField_Int(hContext,"internal_error",iRet);
                }
...
ERRLOG("TxnMmcByUsCTC::Authorize::server node_id not found!!\n");
                iRet = INT_ERR;
...
ERRLOG("TxnMmcByUsCTC::Authorize::TxnTypeHandler Failed\n");
                        }
                        else {
...
ERRLOG("TxnMmcByUsCTC::Authorize::TxnMmsByUs2Node Failed\n");
                                                        }
                                                        else {
...
DEBUGLOG(("TxnMmcByUsCTC Normal Exit() iRet = [%d]\n",iRet));
	return iRet;
}
