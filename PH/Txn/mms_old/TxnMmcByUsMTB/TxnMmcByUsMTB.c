...
void TxnMmcByUsMTB(char    cdebug)
{
	cDebug = cdebug;
}
...
ERRLOG("TxnMmcByUsMTB::Authorize::txnid not found!!\n");
...
ERRLOG("TxnMmcByUsMTB::Authorize::dtl_txnid not found!!\n");
                iRet=INT_INVALID_TXN;
	}
*/
...
ERRLOG("TxnMmcByUsMTB::Authorize::txn_amt not found!!\n");
...
ERRLOG("TxnMmcByUsMTB::Authorize::ccy not found!!\n");
...
ERRLOG("TxnMmcByUsMTB::Authorize::bank_charge_refund not found!!\n");
        }
*/
...
ERRLOG("TxnMmcByUsMTB::Authorize::from_node not found!!\n");
                iRet = PD_ERR;
                PutField_Int(hContext,"internal_error",iRet);
                }
        }
...
ERRLOG("TxnMmcByUsMTB::Authorize::to_node not found!!\n");
                iRet = PD_ERR;
                PutField_Int(hContext,"internal_error",iRet);
                }
        }
...
ERRLOG("TxnMmcByUsMTB::Authorize::TxnTypeHandler Failed\n");
                }
                else {
...
DEBUGLOG(("TxnMmcByUsMTB Normal Exit() iRet = [%d]\n",iRet));
	return iRet;
}
