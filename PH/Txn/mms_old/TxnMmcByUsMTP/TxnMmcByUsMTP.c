...
void TxnMmcByUsMTP(char    cdebug)
{
	cDebug = cdebug;
}
...
ERRLOG("TxnMmcByUsMTP::Authorize::txnid not found!!\n");
...
ERRLOG("TxnMmcByUsMTP::Authorize::dtl_txnid not found!!\n");
                iRet=INT_INVALID_TXN;
	}
*/
...
DEBUGLOG(("Authorize::mb_id = [%s]\n",csTmp));
		...
		PutField_CString(hTxn,"src_party_type",PD_MMS_PARTY_MB);
        }
...
ERRLOG("TxnMmcByUsMTP::Authorize::txn_amt not found!!\n");
...
ERRLOG("TxnMmcByUsMTP::Authorize::ccy not found!!\n");
...
/*ERRLOG("TxnMmcByUsMTP::Authorize::processing_cost not found!!\n");*/
        }
...
/*ERRLOG("TxnMmcByUsMTP::Authorize::bank_charge not found!!\n");*/
        }
...
ERRLOG("TxnMmcByUsMTP::Authorize::bank_charge_refund not found!!\n");
        }
*/
...
ERRLOG("TxnMmcByUsMTP::Authorize::from_node not found!!\n");
                iRet = PD_ERR;
                PutField_Int(hContext,"internal_error",iRet);
                }
        }
...
ERRLOG("TxnMmcByUsMTP::Authorize::to_node not found!!\n");
                iRet = PD_ERR;
                PutField_Int(hContext,"internal_error",iRet);
                }
        }
...
ERRLOG("TxnMmcByUsMPT::Authorize::server node_id not found!!\n");
                iRet = INT_ERR;
...
ERRLOG("TxnMmcByUsMTP::Authorize::TxnTypeHandler Failed\n");
                        }
                        else {
                        ...
                        PutField_CString(hTxn, "process_code", PD_MMS_TRANSFER_TO_PSP);
...
ERRLOG("TxnMmcByUsMTP::Authorize::TxnMmsByUs2Node Failed\n");
                                                        }
                                                        else {
...
DEBUGLOG(("Authorize::Call BOMmsBalance: TxnTypeHandler\n"));
		...
		if (iRet != PD_OK) {
DEBUGLOG(("Authorize::MTPHandler Failed\n"));
ERRLOG("TxnMmcByUsMTP::Authorize::MTPHandler Failed\n");
                }
        }
...
DEBUGLOG(("TxnMmcByUsMTP Normal Exit() iRet = [%d]\n",iRet));
	return iRet;
}
