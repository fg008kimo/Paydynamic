...
Add remark when insufficient funds		   2014/01/24		   LokMan Chow
Add all to fundin payout pool			   2013/03/28		   LokMan Chow
*/
...
DEBUGLOG(("Authorize() (FROM) MGTChannel.UpdateTxnDetailLog update remark failed\n"));
		}
	}
...
DEBUGLOG(("Authorize (TO) !! dRemainTxnFee [%lf]\n", dRemainTxnFee));
		...
		/*add all to fundin payout pool*/
		dAddFundin = dAddFundin+dAddResvPO+dAddPrevFt;
		dAddResvPO = 0.0;
		dAddPrevFt = 0.0;

		dOrgAddFundin = dOrgAddFundin+dOrgAddResvPO+dOrgAddPrevFt;
		dOrgAddResvPO = 0.0;
		dOrgAddPrevFt = 0.0;
		/*-----------------------------*/
