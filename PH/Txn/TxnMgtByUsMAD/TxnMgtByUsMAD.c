...
ERRLOG("TxnMgtByUsMAD::Authorize::txn_code not found!!\n");
                iRet=INT_ERR;
...
ERRLOG("TxnMgtByUsMAD::Authorize::country not found!!\n");
...
ERRLOG("TxnMgtByUsMAD::BOFee::GetTxnFee Failed Ret [%d]\n", iRet);
			iRet = INT_ERR;
                } 	
		else {
...
ERRLOG("TxnMgtByUsMAD::BOADjustment::ProcesspartyBalance Failed Ret [%d]\n", iRet);
		} else {	
...
ERRLOG("TxnMgtByUsMAD::BOADjustment::ProcesspartyBalance Failed to get dc_ind\n");
				iRet = PD_ERR;
			}
