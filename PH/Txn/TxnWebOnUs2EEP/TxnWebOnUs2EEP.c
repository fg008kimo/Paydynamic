...
void TxnWebOnUs2EEP(char    cdebug)
{
        cDebug = cdebug;
}

int     AddEEPTxnLog(hash_t *hContext,
...
{
	int iRet = PD_OK;
	iRet = AddEEPTxnLog(hContext,hRequest);
	return iRet;
}
