...
void TxnOmtByUsOAF(char    cdebug)
{
        cDebug = cdebug;
}
...
ERRLOG("TxnOmtByUsOAF::Authorize::merchant_id not found!!\n");
...
ERRLOG("TxnOmtByUsOAF::Authorize::service_code not found!!\n");
...
ERRLOG("TxnOmtByUsOAF::Authorize::ccy not found!!\n");
...
ERRLOG("TxnOmtByUsOAF:Authorize::invalid service code [%s]\n",csServiceCode);
...
ERRLOG("TxnOmtByUsOAF::Authorize::country not found!!\n");
...
ERRLOG("TxnOmtByUsOAF::Authorize::txn_amt not found!!\n");
...
DEBUGLOG(("Authorize::dc_ind = [%c]\n",cDCInd));
		PutField_Char(hContext, "dc_ind", cDCInd);
	} else {
DEBUGLOG(("Authorize::dc_ind not found!!\n"));
ERRLOG("TxnOmtByUsOAF::Authorize::dc_ind not found!!\n");
		iRet=INT_DC_IND_NOT_FOUND;
		PutField_Int(hContext,"internal_error",iRet);
	}

	PutField_Char(hContext, "party_type", PD_TYPE_MERCHANT);
	PutField_Int(hContext, "chg_bal_mode", PD_FALSE); 
...
DEBUGLOG(("TxnOmtByUsOAF Normal Exit() iRet = [%d]\n",iRet));
	return iRet;
}
