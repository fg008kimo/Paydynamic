...
OBJPTR(DB);
void TxnWebOnUsEGP(char    cdebug)
{
        cDebug = cdebug;
}
...
DEBUGLOG(("TxnWebOnUsEGP Authorize\n"));
...
DEBUGLOG(("TxnWebOnUsEGP Authorize iRet = [%d]\n",iRet));
	return iRet;
}
