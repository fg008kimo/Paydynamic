...
remove party_type, add business_type		   2012/12/11		   [MSN]
Add company name, company address		   2014/09/30		   [WWK]
Add R01, R02 (merchant login policy)		   2016/08/25		   [WWK]
Add rollback if return error                       2021/04/07              [MIC]
*/
