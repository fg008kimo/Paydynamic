...
void TxnOmtByUsOSR(char    cdebug)
{
        cDebug = cdebug;
}
...
ERRLOG("TxnOmtByUsOSR::Authorize::txnid not found!!\n");
...
ERRLOG("TxnOmtByUsOSR::Authorize::merchant_id not found!!\n");
...
ERRLOG("TxnOmtByUsOSR::Authorize::ccy not found!!\n");
...
ERRLOG("TxnOmtByUsOSR::Authorize::country not found!!\n");
...
ERRLOG("TxnOmtByUsOSR::Authorize::txn_amt not found!!\n");
...
DEBUGLOG(("TxnOmtByUsOSR Normal Exit() iRet = [%d]\n",iRet));
	return iRet;
}
