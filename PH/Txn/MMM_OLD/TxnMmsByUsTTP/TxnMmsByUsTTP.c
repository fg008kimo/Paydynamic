...
void TxnMmsByUsTTP(char    cdebug)
{
	cDebug = cdebug;
}
...
ERRLOG("TxnMmsByUsTTP::Authorize::txn_amt not found!!\n");
...
ERRLOG("TxnMmsByUsTTP::Authorize::ccy not found!!\n");
...
ERRLOG("TxnMmsByUsTTP::Authorize::PTMHandler Failed\n");
                }
        }
...
DEBUGLOG(("TxnMmsByUsTTP Normal Exit() iRet = [%d]\n",iRet));
	return iRet;
}
