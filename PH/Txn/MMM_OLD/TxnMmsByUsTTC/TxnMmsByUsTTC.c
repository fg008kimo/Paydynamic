...
void TxnMmsByUsTTC(char    cdebug)
{
	cDebug = cdebug;
}
...
ERRLOG("TxnMmsByUsTTC::Authorize::txn_amt not found!!\n");
...
ERRLOG("TxnMmsByUsTTC::Authorize::ccy not found!!\n");
...
ERRLOG("TxnMmsByUsTTC::Authorize::PTMHandler Failed\n");
                }
        }
...
DEBUGLOG(("TxnMmsByUsTTC Normal Exit() iRet = [%d]\n",iRet));
	return iRet;
}
