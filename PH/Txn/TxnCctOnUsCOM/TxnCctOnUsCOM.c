...
-------------------------------                    ------------            --------------
Init Version                                       2011/09/21              Cody Chan
*/
...
#include "ObjPtr.h"
#include "internal.h"
#include "TxnCctOnUsCOM.h"
#include "myrecordset.h"

char cDebug;

void TxnCctOnUsCOM(char    cdebug)
{
        cDebug = cdebug;
}
...
DEBUGLOG(("TxnCctOnUsCOM: Authroize()\n"));	
/* field checking */
...
ERRLOG("TxnCctOnUsCOM:Authorize() Currency code invalid\n");
                        }
		}
                else{
...
ERRLOG(("TxnCctOnUsCOM:Authorize() Currency code not found\n"));
                }
	}
...
ERRLOG(("TxnCctOnUsCOM:Authorize() txn_amt not found\n"));
                        	}
			}
                }
