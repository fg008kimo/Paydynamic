...
Add PutField init_provider_id into hBankAcct       2018/12/07              Michael Chow
*/
...
ERRLOG("TxnOmtByUsACN:: Authorize:: to_psp_id bank_acct_type not found!!\n");
			...
			// get init_provider_id
			if (GetField_CString(hTmp, "client_id", &csInitProviderId)) {
DEBUGLOG(("Authorize:: to_psp_id init_provider_id = [%s]\n", csInitProviderId));
				PutField_CString(hBankAcct, "init_provider_id", csInitProviderId);
			} else {
