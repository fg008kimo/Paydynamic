...
DEBUGLOG(("Authorize::call BOPayout->HandleCancelApprove\n"));
	...
	if(iRet == PD_SKIP_OK){
		...
		if((unsigned long)(*DBObjPtr)(hTxn)!=PD_OK){
			iRet=INT_ERR;
DEBUGLOG(("Authorize::DBPayoutGeneratedFileDT UpdateByGenId Failed!!!\n"));
ERRLOG("TxnWebOnUsROG::DBPayoutGeneratedFileDT UpdateByGenId Failed!!!\n");
		}
...
ERRLOG("TxnWebOnUsROG::DBTransaction Update Failed!!!\n");
			}
		}
	}
