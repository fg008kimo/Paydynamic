...
/* status */
//	PutField_Char(hReq,"status",PD_COMPLETE);

/* counter */
//	PutField_Int(hReq,"counter", 0);
...
ERRLOG("TxnMgtByUsRTK::Authorize::Call DBTxnAckRetry:CounterReset Fail!\n");
			iRet = INT_ERR;
		}
