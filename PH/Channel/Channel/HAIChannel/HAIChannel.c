...
DEBUGLOG(("Call WEBChannel process_psp_resp_txn\n"));
			PutField_CString(hContext,"return_psp_channel",PD_CHANNEL_HAIPAY);
...
DEBUGLOG(("UpdateContext:NOT RECORD\n"));
                iRet = PD_ERR;
ERRLOG("Internal Error:HAI Channel:SystemControl Record Not Found\n");
        }
...
DEBUGLOG(("process_bounce_txn:BreakDown HAIMsg Error\n"));
        }
        else {
