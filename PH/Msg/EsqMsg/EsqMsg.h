...
#define	MY_ESQ_TOKEN		"&"
#define	MY_ESQ_FIELD_TOKEN	"="
#define MY_ESQ_SUCCESS_STATUS	"1"
#define MY_ESQ_LANG		"GB"

#define PD_OPEN_BRACKET_H	0x7b
#define PD_CLOSE_BRACKET_H	0x7d
#define MY_ESQ_JSON_TOKEN	","
#define MY_ESQ_JSON_FIELD_TOKEN	":"
#define PD_DOUBLE_QUOTE		0x22
#define MY_ESQ_PENDING_STATUS	"9"
