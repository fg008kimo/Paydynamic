...
DEBUGLOG(("DATA = [%s][%d]\n",inMsg,inLen));
        ...
        if (Str2Cls(hRec,(char*)inMsg,MY_OPL_TOKEN, MY_OPL_FIELD_TOKEN) == PD_OK) {	
...
/* dest_ccy */
		if (GetField_CString(hRec,"dest_ccy",&csPtr)) {
                        PutField_CString(hOut,"dest_txn_ccy",csPtr);
DEBUGLOG(("BreakDownMsg:: dest_txn_ccy = [%s]\n",csPtr));
                }
...
/* encrypt_type */
		if (GetField_CString(hRec,"enctype",&csPtr)) {
			...
			/* For VerifyMac */
                        PutField_CString(hOut,"po_encrypt_type",csPtr);
...
/* identity_id */
		if (GetField_CString(hRec,"identity_id",&csPtr)) {
                        PutField_CString(hOut,"identity_id",csPtr);
DEBUGLOG(("BreakDownMsg:: identity_id = [%s]\n",csPtr));
                }

/* bban */
		if (GetField_CString(hRec,"bban",&csPtr)) {
                        PutField_CString(hOut,"bban",csPtr);
DEBUGLOG(("BreakDownMsg:: bban = [%s]\n",csPtr));
                }

/* bbaname */
		if (GetField_CString(hRec,"bbaname",&csPtr)) {
                        PutField_CString(hOut,"bbaname",csPtr);
DEBUGLOG(("BreakDownMsg:: bbaname = [%s]\n",csPtr));
                }

/* bname */
		if (GetField_CString(hRec,"bname",&csPtr)) {
                        PutField_CString(hOut,"bname",csPtr);
DEBUGLOG(("BreakDownMsg:: bname = [%s]\n",csPtr));
                }

/* bcode */
		if (GetField_CString(hRec,"bcode",&csPtr)) {
                        PutField_CString(hOut,"bcode",csPtr);
DEBUGLOG(("BreakDownMsg:: bcode = [%s]\n",csPtr));
                }

/* branch */
		if (GetField_CString(hRec,"branch",&csPtr)) {
                        PutField_CString(hOut,"branch",csPtr);
DEBUGLOG(("BreakDownMsg:: branch = [%s]\n",csPtr));
                }

/* bank_prov */
		if (GetField_CString(hRec,"bank_prov",&csPtr)) {
                        PutField_CString(hOut,"bank_prov",csPtr);
DEBUGLOG(("BreakDownMsg:: bank_prov = [%s]\n",csPtr));
                }

/* bank_city */
		if (GetField_CString(hRec,"bank_city",&csPtr)) {
                        PutField_CString(hOut,"bank_city",csPtr);
DEBUGLOG(("BreakDownMsg:: bank_city = [%s]\n",csPtr));
                }

/* tel_phone */
		if (GetField_CString(hRec,"tel_phone",&csPtr)) {
                        PutField_CString(hOut,"tel_phone",csPtr);
DEBUGLOG(("BreakDownMsg:: tel_phone = [%s]\n",csPtr));
                }

/* payout_group */
		if (GetField_CString(hRec,"payout_group",&csPtr)) {
                        PutField_CString(hOut,"payout_group",csPtr);
DEBUGLOG(("BreakDownMsg:: payout_group = [%s]\n",csPtr));
                }
