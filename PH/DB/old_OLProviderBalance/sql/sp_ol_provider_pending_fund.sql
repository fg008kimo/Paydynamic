CREATE OR REPLACE FUNCTION sp_ol_provider_pending_fund(
	...
	in_bal			ol_provider_balance.ol_pb_pending_fund%type,
	in_create_user		ol_provider_balance.ol_pb_create_user%type
)
return number is
begin
	update ol_provider_balance
	  set ol_pb_pending_fund = ol_pb_pending_fund + in_bal,
...
exception
  when others then
  return 9;
end sp_ol_provider_pending_fund;
/
