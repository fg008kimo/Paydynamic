DROP VIEW PSP_DAY_LIMIT_MERCHANT_VIEW;


CREATE OR REPLACE FORCE VIEW PSP_DAY_LIMIT_MERCHANT_VIEW
(
   CLIENT_ID,
   CLIENT_NAME,
   MERCHANT_ID,
...
AS
     SELECT MERCH_DETAIL.CLIENT_ID AS CLIENT_ID,
            ...
            MERCH_DETAIL.RC_CUSTOMER_SEGMENT AS CUTOMER_SEGMENT,
            ...
            MERCH_DETAIL.RC_COUNTRY AS COUNTRY,
       ...
       FROM (  SELECT CLIENT_ID,
                 ...
                 FROM (SELECT RC_CHANNEL_CODE,
                        ...
                        WHERE     RULE_TXN_LIMIT_PKG.FINDTODAYSCHEDULE (
                                     RC_SCHEDULER_ID) = 1
             ...
             GROUP BY CLIENT_ID,
                      ...
                      RC_SERVICE_CODE,
                      RC_COUNTRY,
                      RC_ALLOW_SPECIAL_REGION) MERCH_DETAIL,
