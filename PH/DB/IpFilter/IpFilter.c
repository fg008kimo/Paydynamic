...
static unsigned int sqlctx = 152699;
...
{12,4130,871,0,0,
5,0,0,1,159,0,4,63,0,0,5,4,0,1,0,2,3,0,0,1,3,0,0,1,3,0,0,1,3,0,0,1,3,0,0,
};
...

{
 ...
 sqlstm.stmt = "select COUNT ( * ) INTO :b0 from IP_FILTER where IP_DISABLE\
D = 0 AND IP_START_HIGH <= :b1 AND IP_END_HIGH >= :b1 AND IP_START_LOW <= :b3\
 AND IP_END_LOW >= :b3 ";
 ...
 sqlstm.sqhstv[1] = (unsigned char  *)&hv_ip_high;
 ...
 sqlstm.sqhstv[2] = (unsigned char  *)&hv_ip_high;
 ...
 sqlstm.sqhstv[3] = (unsigned char  *)&hv_ip_low;
 ...
 sqlstm.sqhstv[4] = (unsigned char  *)&hv_ip_low;
 ...
 if (sqlca.sqlcode < 0) goto getfilter_error;
}
