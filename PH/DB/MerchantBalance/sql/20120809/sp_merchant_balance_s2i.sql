CREATE OR REPLACE FUNCTION PHUSER.sp_merchant_balance_s2i(
	...
	in_fee			merchant_balance.m_current_bal%type,
	in_update_user		merchant_balance.m_update_user%type
)
return number is
begin
	update merchant_balance
	  set m_current_bal = m_current_bal - in_amt - in_fee,
	      m_settlement_in_transit = m_settlement_in_transit + in_amt,
