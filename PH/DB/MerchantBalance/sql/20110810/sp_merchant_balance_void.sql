CREATE OR REPLACE FUNCTION sp_merchant_balance_void(
	...
	in_aval_bal		merchant_balance.m_aval_bal%type,
	in_create_user		merchant_balance.m_create_user%type
)
return number is
begin
	update merchant_balance
	  set m_aval_bal = m_aval_bal + in_aval_bal,
