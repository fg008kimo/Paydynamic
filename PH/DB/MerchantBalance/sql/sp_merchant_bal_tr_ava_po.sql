CREATE OR REPLACE FUNCTION sp_merchant_bal_tr_ava_po(
	...
	in_resv_po		merchant_balance.m_reserved_payout%type,
	in_amt	                merchant_balance.m_current_bal%type,
...
begin
	update merchant_balance
	  set m_fundin_payout = m_fundin_payout + in_fundin,
	      m_reserved_payout = m_reserved_payout + in_resv_po,
	...
	if SQL%ROWCOUNT = 0 THEN
		insert into merchant_balance (m_merchant_id, m_currency_id, m_country_id, m_service_code, 
					      m_current_bal, m_fundin_payout, m_reserved_payout,
					      m_create_timestamp, m_update_timestamp, m_create_user, m_update_user)
