CREATE OR REPLACE FUNCTION PHUSER.sp_merchant_balance_release_pb(
...
begin
	update merchant_balance
	  set m_payout_bal = m_payout_bal+in_payout_bal,
	      m_total_float = m_total_float - in_payout_bal,
...
exception
  when others then
  return 9;
end sp_merchant_balance_release_pb;
/
