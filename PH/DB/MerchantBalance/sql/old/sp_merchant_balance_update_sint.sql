CREATE OR REPLACE FUNCTION PHUSER.sp_merch_balance_update_sint(
	...
	in_settlement_in_transit	merchant_balance.m_settlement_in_transit%type,
	in_create_user		merchant_balance.m_create_user%type
)
return number is
begin
	update merchant_balance
	  set m_settlement_in_transit = m_settlement_in_transit - in_settlement_in_transit,
...
exception
  when others then
  return 9;
end sp_merch_balance_update_sint;
/
