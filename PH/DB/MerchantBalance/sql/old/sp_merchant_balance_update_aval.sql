CREATE OR REPLACE FUNCTION PHUSER.sp_merch_balance_update_aval(
	...
	in_bal			merchant_balance.m_settlement_bal%type,
	in_create_user		merchant_balance.m_create_user%type
)
return number is
begin
	update merchant_balance
	  set m_settlement_bal = m_settlement_bal + in_bal,
