...
static unsigned int sqlctx = 19823939;
...
{12,4130,871,0,0,
5,0,0,1,72,0,4,50,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
};
...
struct { unsigned short len; unsigned char arr[21]; } v_status_group;
...

{
 ...
 sqlstm.stmt = "select as_group into :b0:b1 from ol_def_acct_status where a\
s_type = :b2 ";
 ...
 sqlstm.sqhstv[0] = (unsigned char  *)&v_status_group;
 sqlstm.sqhstl[0] = (unsigned long )23;
 sqlstm.sqhsts[0] = (         int  )0;
 sqlstm.sqindv[0] = (         short *)&ind_status_group;
 ...
 if (sqlca.sqlcode < 0) goto getstatusgroup_error;
}
