...
{
    26,
    "VoucherPaymentParameter.pc"
};


static unsigned int sqlctx = 1216771003;
...
{12,4130,871,0,0,
5,0,0,1,77,0,4,48,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
28,0,0,2,66,0,9,90,0,2049,0,0,0,1,0,
43,0,0,2,0,0,13,93,0,0,2,0,0,1,0,2,9,0,0,2,9,0,0,
66,0,0,2,0,0,15,119,0,0,0,0,0,1,0,
81,0,0,2,0,0,15,128,0,0,0,0,0,1,0,
96,0,0,3,0,0,17,165,0,0,1,1,0,1,0,1,9,0,0,
115,0,0,3,0,0,21,166,0,0,0,0,0,1,0,
};
...

{
        ...
        sqlstm.stmt = "select vp_val INTO :b0:b1 FROM voucher_payment_param\
eter WHERE vp_code = :b2 ";
