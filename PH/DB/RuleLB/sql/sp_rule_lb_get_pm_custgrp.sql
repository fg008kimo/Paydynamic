CREATE OR REPLACE FUNCTION sp_rule_lb_get_pm_custgrp (
   ...
   in_from_group         CUSTOMER_GROUP_RULES.CGR_FROM_GROUP_CODE%TYPE,
    ...
    FROM (SELECT rc_customer_segment,
            ...
            FROM (SELECT rc_customer_segment,
				   ...
				   (select CGR_GROUP_CODE
				    ...
				    where CGR_FROM_GROUP_CODE = in_from_group
				    and CGR_DISABLED = 0
				   )
