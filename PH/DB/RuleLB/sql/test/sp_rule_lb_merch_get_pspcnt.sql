CREATE OR REPLACE FUNCTION sp_rule_lb_merch_get_pspcnt(
...
BEGIN
  ...
  SELECT bm_int_bank_code,
    ...
    FROM (  SELECT bm_int_bank_code,
          ...
          ORDER BY fe_display_order, remaining_limit DESC)
GROUP BY bm_int_bank_code;
...
EXCEPTION
   ...
   THEN
      RETURN 9;
END sp_rule_lb_merch_get_pspcnt;
/
