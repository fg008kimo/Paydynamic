CREATE OR REPLACE FUNCTION sp_rule_lb_get_bankoutage(
...
BEGIN
   OPEN out_cursor FOR
      SELECT --bm_int_bank_code,
	     ...
	     and   bm_int_bank_code = in_bank_code
	     and   rb_scheduler_id is not null
          group by rb_scheduler_id,rb_note_id;
