CREATE OR REPLACE FUNCTION sp_rulelb_pmcust_cardtype_get(
      ...
      SELECT bm_int_bank_code,
              ...
              FROM (  SELECT bm_int_bank_code,
                        ...
                        FROM (SELECT psp_name,
                                     ...
                                     rc_service_code,credit_option,debit_option,deposit_card_type
						       ...
						       AND (rc_customer_segment  is NULL
							    OR (rc_customer_segment in (select CGR_GROUP_CODE
                                     ...
                                     (SELECT psp_name,
                                             client_id,
                                             psp_channel_code,
                                             overrided_bank_code_channel,deposit_card_type,
                                             rpp_psp_id,
                                             currency_id,
                                             rpp_limit,
                                             CASE
...
EXCEPTION
   ...
   THEN
      RETURN 9;
END sp_rulelb_pmcust_cardtype_get;
/
