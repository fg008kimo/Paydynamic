...
static unsigned int sqlctx = 1354739;
...
extern void sqliem( unsigned char *, signed int * );
 ...
 static char *sq0002 = 
"select /*+ NO_CPU_COSTING +*/ te_ccy , te_amount , te_rate from txn_element\
s where te_txn_id = :b0 and te_txn_element_type = :b1 and te_party_type = :b2\
            ";

 static char *sq0003 = 
"select te_txn_element_type , te_ccy , te_amount , te_amt_type , te_party_ty\
pe , te_rate , te_exec_seq from txn_elements where te_txn_id = :b0 order by t\
e_exec_seq desc            ";
...
{12,4130,871,0,0,
5,0,0,1,276,0,6,129,0,0,9,9,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,1,1,0,0,1,4,0,0,1,9,
0,0,1,9,0,0,1,4,0,0,1,9,0,0,
56,0,0,2,164,0,9,228,0,2049,3,3,0,1,0,1,9,0,0,1,9,0,0,1,1,0,0,
83,0,0,2,0,0,13,230,0,0,3,0,0,1,0,2,9,0,0,2,4,0,0,2,4,0,0,
110,0,0,2,0,0,15,267,0,0,0,0,0,1,0,
125,0,0,2,0,0,15,277,0,0,0,0,0,1,0,
140,0,0,3,179,0,9,331,0,2049,1,1,0,1,0,1,9,0,0,
159,0,0,3,0,0,13,333,0,0,7,0,0,1,0,2,9,0,0,2,9,0,0,2,4,0,0,2,9,0,0,2,1,0,0,2,4,
0,0,2,3,0,0,
202,0,0,3,0,0,15,400,0,0,0,0,0,1,0,
217,0,0,3,0,0,15,410,0,0,0,0,0,1,0,
232,0,0,4,0,0,17,470,0,0,1,1,0,1,0,1,9,0,0,
251,0,0,4,0,0,21,471,0,0,0,0,0,1,0,
};
...
Modify GetFeeChgDetailByType			   2016/06/29		   Elvis Wong	
*/
...
DEBUGLOG(("Update: Begin\n"));
        ...
        strcpy((char*)hv_dynstmt.arr,"update txn_elements set te_update_timestamp  = sysdate");
...
DEBUGLOG(("Update:amount = [%lf]\n",dTmp));
		...
		strcat((char*)hv_dynstmt.arr, ",te_amount = ");
...
DEBUGLOG(("Update:rate = [%lf]\n",dTmp));
		sprintf(csBuf,"%f",dTmp);
		strcat((char*)hv_dynstmt.arr, ",te_rate = ");
		strcat((char*)hv_dynstmt.arr, csBuf);
		hv_dynstmt.len = strlen((const char*)hv_dynstmt.arr);
	}

	strcat((char *)hv_dynstmt.arr, " WHERE te_txn_id = '");
	strcat((char *)hv_dynstmt.arr, csTxnId);
	strcat((char *)hv_dynstmt.arr, "'");
	strcat((char *)hv_dynstmt.arr, "AND te_exec_seq = ");
...
ERRLOG("TxnElements_Update: SP_INTERNAL_ERR TxnAbort\n");
