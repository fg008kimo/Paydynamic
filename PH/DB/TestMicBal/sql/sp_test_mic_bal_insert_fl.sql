CREATE OR REPLACE FUNCTION sp_test_mic_bal_insert_fl(
	...
	out_total_float	out	test_mic_bal.m_total_float%type,
	out_current_bal	out	test_mic_bal.m_current_bal%type,
	out_current_bal_settlement	out	test_mic_bal.m_current_bal_settlement%type,
	out_total_reserved_amount	out	test_mic_bal.m_total_reserved_amount%type
)
return number is
begin
	update test_mic_bal
