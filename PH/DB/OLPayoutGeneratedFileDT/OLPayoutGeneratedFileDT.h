#ifndef _OL_PAYOUR_GENEREATED_FILE_DT_H_
#define _OL_PAYOUR_GENEREATED_FILE_DT_H_
...
int GetBlockCancelCount(hash_t *hTxn);
int GetAuxTxnIdByUploadTxnId(const hash_t *hTxn, recordset_t* myRec);
int GetApiFileDetailByUploadTxnId(const hash_t *hTxn, recordset_t* myRec);
#ifdef __cplusplus
}
#endif
