...
(
  ...
  OBT_RECON_STATUS           CHAR(1 BYTE),
  OBT_CLASSIFIED_STATUS      CHAR(1 BYTE),
  ...
  OBT_MANUAL_HOLD_RECCON     INTEGER
)
...
ALTER TABLE OL_BAID_TXN ADD (
  ...
  ENABLE VALIDATE,
  CONSTRAINT OL_BAID_TXN_FK02 
  FOREIGN KEY (OBT_RECON_STATUS) 
  REFERENCES OL_DEF_RECON_STATUS (RS_TYPE)
  ENABLE VALIDATE,
  CONSTRAINT OL_BAID_TXN_FK03 
  FOREIGN KEY (OBT_CLASSIFIED_STATUS) 
