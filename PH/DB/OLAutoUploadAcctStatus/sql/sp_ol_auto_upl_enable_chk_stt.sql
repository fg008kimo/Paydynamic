...
CREATE OR REPLACE FUNCTION sp_ol_auto_upl_enable_chk_stt(
...
BEGIN
	...
	and	oauas_enable_chk_to_status = (select oauas_enable_chk_fr_status
					      from   ol_auto_upload_acct_status
					      where  oauas_acct_type = in_acct_type
					      and    oauas_status_type = in_fr_status_type
					      and    oauas_enable_chk_fr_status > 0
					      and    oauas_disabled = 0 		
					     )
       	and     oauas_enable_chk_to_status > 0
       	and     oauas_disabled = 0;
...
END sp_ol_auto_upl_enable_chk_stt;
/
