...
(
  ...
  OLSD_TFR_BANK_NAME        VARCHAR2(200 BYTE),
  OLSD_TFR_BANK_ACCT_NUM    VARCHAR2(200 BYTE),
  OLSD_TFR_TYPE             VARCHAR2(640 BYTE),
  OLSD_TFR_CHANNEL          VARCHAR2(640 BYTE),
  OLSD_TFR_TEXT             VARCHAR2(200 BYTE),
  OLSD_TFR_CUSTOMER_TEXT    VARCHAR2(640 BYTE),
  OLSD_SENDER_NAME          VARCHAR2(200 BYTE),
  OLSD_TXN_REF_NUM          VARCHAR2(200 BYTE),
  OLSD_KEYWORDS_MAPPING     VARCHAR2(401 BYTE),
  ...
  OLSD_RAW_DATE             VARCHAR2(50 BYTE),
  OLSD_RAW_TIME             VARCHAR2(50 BYTE),
  OLSD_SENDER_BAID_NAME     VARCHAR2(100 BYTE),
  OLSD_RECIPIENT_BAID_NAME  VARCHAR2(100 BYTE),
  OLSD_CLIENT_NAME          VARCHAR2(50 BYTE),
  OLSD_TXN_LOCATION         VARCHAR2(640 BYTE),
  OLSD_TXN_TYPE             VARCHAR2(640 BYTE),
  OLSD_TXN_REFERENCE        VARCHAR2(640 BYTE)
)
...
(OLSD_FILE_ID, OLSD_STATEMENT_SEQ)
LOGGING
TABLESPACE USER_IDX
PCTFREE    10
INITRANS   2
...
CREATE INDEX OL_STATEMENT_DETAIL_IDX07 ON OL_STATEMENT_DETAIL
...
CREATE INDEX OL_STATEMENT_DETAIL_IDX08 ON OL_STATEMENT_DETAIL
