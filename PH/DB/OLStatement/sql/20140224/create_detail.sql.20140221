...
--  OLSD_SUB_STATUS          CHAR(3 BYTE),
--  OLSD_TYPE                VARCHAR2(3 BYTE),
--  OLSD_PROCESS_GROUP       CHAR(1 BYTE),
...
CREATE UNIQUE INDEX OL_STATEMENT_DETAIL_IDX02 ON OL_STATEMENT_DETAIL
(OLSD_SMS_TXN_ID)
LOGGING
TABLESPACE USER_IDX
PCTFREE    10
...
(OLSD_INT_BANK_CODE, OLSD_BANK_ACCT_NUM, OLSD_STATEMENT_DATE, OLSD_TXN_AMOUNT)
LOGGING
TABLESPACE USER_IDX
PCTFREE    10
INITRANS   2
...
(OLSD_PROCESS_GROUP, OLSD_STATUS, OLSD_TYPE, OLSD_INT_BANK_CODE, OLSD_BANK_ACCT_NUM, OLSD_STATEMENT_REF)
LOGGING
TABLESPACE USER_IDX
PCTFREE    10
INITRANS   2
...
ALTER TABLE OL_STATEMENT_DETAIL ADD (
  ...
  REFERENCES OL_DEF_STATEMENT_STATUS (DSS_TYPE)
  ENABLE VALIDATE,
  ...
  ENABLE VALIDATE,
  CONSTRAINT OL_STATEMENT_DETAIL_FK08
  FOREIGN KEY (OLSD_PROCESS_GROUP)
  REFERENCES OL_DEF_PROCESS_GROUP (DP_PROCESS_GROUP)
  ENABLE VALIDATE,
  CONSTRAINT OL_STATEMENT_DETAIL_FK09
  FOREIGN KEY (OLSD_TYPE)
  REFERENCES OL_DEF_STATEMENT_TYPE (DST_TYPE)
  ENABLE VALIDATE,
  CONSTRAINT OL_STATEMENT_DETAIL_FK10
  FOREIGN KEY (OLSD_SUB_STATUS)
  REFERENCES OL_DEF_STATEMENT_SUB_STATUS (DSSS_TYPE)
  ENABLE VALIDATE);
