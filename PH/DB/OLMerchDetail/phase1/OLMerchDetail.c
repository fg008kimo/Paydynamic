...
expired_days , md_stmt_auto_expired_mins , md_payout_checksum , md_address fr\
om ol_merch_detail where md_merchant_id = :b0            ";
...
{12,4130,871,0,0,
5,0,0,1,1019,0,6,262,0,0,24,24,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,
3,0,0,1,9,0,0,1,4,0,0,1,9,0,0,1,3,0,0,1,3,0,0,1,3,0,0,1,3,0,0,1,3,0,0,1,3,0,0,
1,3,0,0,1,3,0,0,1,3,0,0,1,3,0,0,1,3,0,0,1,3,0,0,1,3,0,0,1,9,0,0,1,9,0,0,
116,0,0,2,79,0,6,336,0,0,2,2,0,1,0,2,3,0,0,1,9,0,0,
139,0,0,3,517,0,9,460,0,2049,1,1,0,1,0,1,9,0,0,
158,0,0,3,0,0,13,462,0,0,21,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,9,0,0,2,
4,0,0,2,9,0,0,2,3,0,0,2,3,0,0,2,3,0,0,2,3,0,0,2,3,0,0,2,3,0,0,2,3,0,0,2,3,0,0,
2,3,0,0,2,3,0,0,2,3,0,0,2,3,0,0,2,3,0,0,2,9,0,0,
257,0,0,3,0,0,15,632,0,0,0,0,0,1,0,
272,0,0,3,0,0,15,647,0,0,0,0,0,1,0,
287,0,0,4,186,0,4,673,0,0,2,1,0,1,0,2,3,0,0,1,9,0,0,
310,0,0,5,0,0,17,918,0,0,1,1,0,1,0,1,9,0,0,
329,0,0,5,0,0,21,919,0,0,0,0,0,1,0,
344,0,0,6,79,0,4,955,0,0,2,1,0,1,0,2,3,0,0,1,9,0,0,
};
...
Add ChkOLMerchIDExist				   2013/09/10		   LokMan Chow
Add MD_DEPOSIT_REQUEST_VER                         2013/10/09              Stan Poon
...

{
 ...
 sqlstm.stmt = "begin :hv_return_value := sp_ol_merch_detail_insert ( :hv_m\
erchant_id:ind_merchant_id , :hv_name:ind_name , :hv_short_name:ind_short_nam\
e , :hv_brand_name:ind_brand_name , :hv_disabled:ind_disabled , :hv_client_id\
:ind_client_id , :hv_approximate_fee_rate:ind_approximate_fee_rate , :hv_stat\
us:ind_status , :hv_allow_payout_dup_merch_ref:ind_allow_payout_dup_merch_ref\
 , :hv_settlement_process_period:ind_settlement_process_period , :hv_ignore_n\
ack:ind_ignore_nack , :hv_payout_fe_display:ind_payout_fe_display , :hv_depos\
it_req_ver:ind_deposit_req_ver , :hv_display_other_bank:ind_display_other_ban\
k , :hv_is_more_restricted:ind_is_more_restricted , :hv_support_payout_grp:in\
d_support_payout_grp , :hv_txn_auto_expired_days:ind_txn_auto_expired_days , \
:hv_txn_auto_expired_mins:ind_txn_auto_expired_mins , :hv_stmt_auto_expired_d\
ays:ind_stmt_auto_expired_days , :hv_stmt_auto_expired_mins:ind_stmt_auto_exp\
ired_mins , :hv_po_checksum:ind_po_checksum , :hv_address:ind_address , :hv_c\
reate_user:ind_create_user ) ; END ;";
 ...
 sqlstm.sqhstv[21] = (unsigned char  *)&hv_po_checksum;
 sqlstm.sqhstl[21] = (unsigned long )sizeof(int);
 sqlstm.sqhsts[21] = (         int  )0;
 sqlstm.sqindv[21] = (         short *)&ind_po_checksum;
 sqlstm.sqinds[21] = (         int  )0;
 sqlstm.sqharm[21] = (unsigned long )0;
 sqlstm.sqadto[21] = (unsigned short )0;
 sqlstm.sqtdso[21] = (unsigned short )0;
 sqlstm.sqhstv[22] = (unsigned char  *)&hv_address;
 sqlstm.sqhstl[22] = (unsigned long )202;
 sqlstm.sqhsts[22] = (         int  )0;
 sqlstm.sqindv[22] = (         short *)&ind_address;
 sqlstm.sqinds[22] = (         int  )0;
 sqlstm.sqharm[22] = (unsigned long )0;
 sqlstm.sqadto[22] = (unsigned short )0;
 sqlstm.sqtdso[22] = (unsigned short )0;
 sqlstm.sqhstv[23] = (unsigned char  *)&hv_create_user;
 sqlstm.sqhstl[23] = (unsigned long )22;
 sqlstm.sqhsts[23] = (         int  )0;
 sqlstm.sqindv[23] = (         short *)&ind_create_user;
