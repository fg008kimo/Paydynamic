...
086000|TXN_CODE_PDF|008|OOC|Overpaid Payout Cr Adj|Transaction Type*|1
086000|TXN_CODE_PDF|009|OOD|Overpaid Payout Dr Adj|Transaction Type*|1
086000|TXN_CODE_PDF|010|OOD|Over-Settlement|Transaction Type*|2
086000|TXN_CODE_PDF|011|CGP|Paid Provider Charge|Transaction Type*|1
...
086000|TXN_CODE_PDF|014|OPR|Overpaid Offline Provider Charge Cr Adj|Transaction Type*|1
086000|TXN_CODE_PDF|015|CPD|Paid Offline Provider Charge (Discount)|Transaction Type*|1
086000|TXN_CODE_PDF|016|VUF|Returned Sweep Out from Pending Fund to Intermediate|Transaction Type*|1
086000|TXN_CODE_PDF|017|VUF|Returned Sweep Out from Pending Fund to Payout|Transaction Type*|2
...
886000|TXN_CODE_PDF|008|OOC|Overpaid Payout Cr Adj|Transaction Type*|1
886000|TXN_CODE_PDF|009|OOD|Overpaid Payout Dr Adj|Transaction Type*|1
886000|TXN_CODE_PDF|010|OOD|Over-Settlement|Transaction Type*|2
886000|TXN_CODE_PDF|011|CGP|Paid Provider Charge|Transaction Type*|1
...
886000|TXN_CODE_PDF|014|OPR|Overpaid Offline Provider Charge Cr Adj|Transaction Type*|1
886000|TXN_CODE_PDF|015|CPD|Paid Offline Provider Charge (Discount)|Transaction Type*|1
886000|TXN_CODE_PDF|016|VUF|Returned Sweep Out from Pending Fund to Intermediate|Transaction Type*|1
886000|TXN_CODE_PDF|017|VUF|Returned Sweep Out from Pending Fund to Payout|Transaction Type*|2
