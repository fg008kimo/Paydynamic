...
{
    22,
    "ClientMagicGpStatus.pc"
};


static unsigned int sqlctx = 297051459;
...
{12,4130,871,0,0,
5,0,0,1,177,0,6,90,0,0,5,5,0,1,0,2,3,0,0,1,9,0,0,1,3,0,0,1,1,0,0,1,9,0,0,
40,0,0,2,105,0,4,159,0,0,3,2,0,1,0,2,1,0,0,1,9,0,0,1,3,0,0,
67,0,0,3,107,0,4,214,0,0,3,2,0,1,0,2,3,0,0,1,9,0,0,1,3,0,0,
};
...

{
 ...
 sqlstm.stmt = "begin :hv_return_value := sp_client_magic_gp_status_ins ( :\
hv_client:ind_client , :hv_txn_gp_id:ind_txn_gp_id , :hv_status:ind_status , \
:hv_create_user:ind_create_user ) ; END ;";
 ...
 sqlstm.sqhstv[2] = (unsigned char  *)&hv_txn_gp_id;
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "select GS_STATUS INTO :b0:b1 from client_magic_gp_status wh\
ere gs_client_id = :b2 and gs_txn_gp_id = :b3 ";
 sqlstm.iters = (unsigned int  )1;
 ...
 sqlstm.sqadto[1] = (unsigned short )0;
 sqlstm.sqtdso[1] = (unsigned short )0;
 sqlstm.sqhstv[2] = (unsigned char  *)&hv_gp_txn_id;
 sqlstm.sqhstl[2] = (unsigned long )sizeof(int);
 sqlstm.sqhsts[2] = (         int  )0;
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "select count ( 1 ) INTO :b0:b1 from client_magic_gp_status \
where gs_client_id = :b2 and gs_txn_gp_id = :b3 ";
 sqlstm.iters = (unsigned int  )1;
 ...
 sqlstm.sqptdso = sqlstm.sqtdso;
 sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
 if (sqlca.sqlcode < 0) goto chkgprecexists_error;
}
