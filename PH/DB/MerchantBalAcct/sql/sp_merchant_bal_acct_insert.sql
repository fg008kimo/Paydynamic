CREATE OR REPLACE FUNCTION sp_merchant_bal_acct_insert(
	...
	in_preferred_acr_pool	merchant_bal_acct.mb_preferred_acr_pool%type,
	in_min_settle_amt	merchant_bal_acct.mb_min_settle_amt%type,
	in_min_settle_amt_applytoadmin  merchant_bal_acct.mb_min_settle_amt_applytoadmin%type,
	in_avai_po_percentage	merchant_bal_acct.mb_avai_po_percentage%type,
	in_client_sett_bank_id	merchant_bal_acct.mb_client_sett_bank_id%type,
...
BEGIN
  ...
  VALUES(
	...
	in_min_settle_amt,
	in_min_settle_amt_applytoadmin,
