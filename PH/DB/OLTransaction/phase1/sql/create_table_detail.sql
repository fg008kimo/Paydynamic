...
(
  ...
  OTD_DEPOSIT_BANK_CODE         VARCHAR2(10 BYTE),
  ...
  OTD_TOTAL_RESERVED_AMOUNT     NUMBER(14,2),
  OTD_FUNDIN_PAYOUT             NUMBER(14,2),
  OTD_RESERVED_PAYOUT           NUMBER(14,2),
  OTD_TOTAL_FLOAT_AFTER_PAYOUT  NUMBER(14,2),
  OTD_OPEN_BAL_SETTLEMENT       NUMBER(14,2),
  OTD_CURRENT_BAL_SETTLEMENT    NUMBER(14,2),
  OTD_TOTAL_FLOAT_SETTLEMENT    NUMBER(14,2),
  OTD_TOTAL_HOLD_SETTLEMENT     NUMBER(14,2),
  OTD_FE_DOMAIN                 VARCHAR2(50 BYTE),
  OTD_CUST_DEPOSIT_DATETIME     VARCHAR2(14 BYTE),
  OTD_BANK_DESPIT_DATETIME      VARCHAR2(14 BYTE),
  OTD_CUSTOMER_TAG              VARCHAR2(10 BYTE),
  OTD_DEPOSIT_FLOW              CHAR(1 BYTE),
  OTD_CUST_DEPOSIT_DT_PROV	INTEGER		DEFAULT 0
)
