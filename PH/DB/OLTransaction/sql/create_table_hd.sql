...
(
  ...
  OTH_RESERVE_AMOUNT         NUMBER(12,2)       DEFAULT 0,
  ...
  OTH_RESERVED_RELEASE_DATE  VARCHAR2(8 BYTE),
  ...
  OTH_DEPOSIT_AMOUNT         NUMBER(12,2),
  OTH_DISPLAY_AMOUNT         NUMBER(12,2),
  OTH_FILENAME               VARCHAR2(100 BYTE),
  OTH_DST_TXN_ID             VARCHAR2(16 BYTE),
  OTH_ACK_STATUS             CHAR(3 BYTE),
  OTH_MATCHING_TIMESTAMP     DATE,
  OTH_UPLOAD_CHANNEL         INTEGER,
  OTH_MULTI_MATCH_IND        INTEGER            DEFAULT 0,
  OTH_RECON_STATUS           CHAR(1 BYTE),
  OTH_RECON_DATE             VARCHAR2(8 BYTE),
  OTH_RECON_TIME             VARCHAR2(6 BYTE),
  OTH_VERSION_NO             INTEGER
)
...
CREATE INDEX OL_TXN_HEADER_IDX25 ON OL_TXN_HEADER
(OTH_TXN_CODE, OTH_STATUS, OTH_AR_IND, OTH_SUB_STATUS)
LOGGING
TABLESPACE USER_IDX
PCTFREE    10
INITRANS   2
