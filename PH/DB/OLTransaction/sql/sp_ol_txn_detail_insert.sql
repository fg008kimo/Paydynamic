create or replace function sp_ol_txn_detail_insert(
       ...
       in_cust_deposit_datetime			ol_txn_detail.otd_cust_deposit_datetime%type,
       in_bank_deposit_datetime			ol_txn_detail.otd_bank_deposit_datetime%type,
       in_bank_acct_num				ol_txn_detail.otd_bank_acct_num%type,
       in_deposit_bank_code			ol_txn_detail.otd_deposit_bank_code%type,
       ...
       in_customer_tag				ol_txn_detail.otd_customer_tag%type,
       in_deposit_flow				ol_txn_detail.otd_deposit_flow%type,
       in_cust_deposit_dt_prov			ol_txn_detail.otd_cust_deposit_dt_prov%type
...
Begin
     Update ol_txn_detail
		  ...
		  otd_bank_deposit_datetime = in_bank_deposit_datetime,
		  ...
		  otd_opt_2 = in_opt_2,
		  otd_opt_3 = in_opt_3,
		  otd_customer_tag = in_customer_tag,
		  otd_deposit_flow = in_deposit_flow,
		  otd_cust_deposit_dt_prov = in_cust_deposit_dt_prov
     ...
     IF SQL%ROWCOUNT = 0 THEN
        insert into ol_txn_detail
		      ...
		      otd_customer_tag,
		      otd_deposit_flow,
                      otd_cust_deposit_dt_prov)
          values(in_txn_id,
		     in_txn_ccy,
                     in_txn_country,
		     in_pay_method,
		     in_cust_deposit_datetime,
		     in_bank_deposit_datetime,
		     in_bank_acct_num,
