...
{
    21,
    "MmsEntityNatureGrp.pc"
};


static unsigned int sqlctx = 162336091;
...
{12,4130,871,0,0,
5,0,0,1,80,0,4,51,0,0,2,1,0,1,0,2,3,0,0,1,9,0,0,
};
...
struct { unsigned short len; unsigned char arr[5]; } hv_nature_grp;
...

{
 ...
 sqlstm.stmt = "select count ( 1 ) INTO :b0 FROM mms_entity_nature_grp WHER\
E meng_code_id = :b1 ";
 ...
 sqlstm.sqhstv[1] = (unsigned char  *)&hv_nature_grp;
