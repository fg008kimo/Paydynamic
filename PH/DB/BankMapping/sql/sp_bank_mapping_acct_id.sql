...
Begin
	...
	from psp_detail,
        ...
        where --PSP_DETAIL.PSP_CHANNEL_CODE = BANK_MAPPING.BM_PSP_CHANNEL_ID
	      ((psp_detail.overrided_bank_code_channel is not NULL and BANK_MAPPING.bm_psp_channel_id = psp_detail.overrided_bank_code_channel)
	...
	and	psp_master.pm_client_id = psp_detail.client_id
