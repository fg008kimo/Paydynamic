CREATE OR REPLACE FUNCTION sp_ol_merch_balance_upd_po_res(
	...
	in_po_reserved		ol_merchant_balance.om_reserved_payout%type,
	in_create_user		ol_merchant_balance.om_create_user%type
)
return number is
begin
	update ol_merchant_balance
	  set om_reserved_payout = om_reserved_payout + in_po_reserved,
...
exception
  when others then
  return 9;
end sp_ol_merch_balance_upd_po_res;
/
