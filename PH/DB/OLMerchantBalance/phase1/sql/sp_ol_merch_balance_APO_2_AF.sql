CREATE OR REPLACE FUNCTION PHUSER.sp_ol_merch_balance_APO_2_AF(
...
begin
	update ol_merchant_balance
	  set
              om_total_float_after_payout = om_total_float_after_payout + in_amt,
...
exception
  when others then
  return 9;
end sp_ol_merch_balance_APO_2_AF;
/
