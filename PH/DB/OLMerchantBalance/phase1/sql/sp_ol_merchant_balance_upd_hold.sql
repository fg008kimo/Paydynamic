CREATE OR REPLACE FUNCTION sp_ol_merchant_bal_upd_hold(
	...
	in_hold			ol_merchant_balance.om_total_hold%type,
	in_create_user		ol_merchant_balance.om_create_user%type
)
return number is
begin
	update ol_merchant_balance
	  set om_total_hold = om_total_hold + in_hold,
...
exception
  when others then
  return 9;
end sp_ol_merchant_bal_upd_hold;
/
