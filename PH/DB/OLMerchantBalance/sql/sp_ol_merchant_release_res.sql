CREATE OR REPLACE FUNCTION sp_ol_merchant_release_res(
        ...
        in_release_amt          ol_merchant_balance.om_total_reserved_amount%type,
        in_create_user          ol_merchant_balance.om_create_user%type
)
return number is
begin
        update ol_merchant_balance
          set om_total_reserved_amount = om_total_reserved_amount - in_release_amt,
...
exception
  when others then
  return 9;
end sp_ol_merchant_release_res;
/
