...
{
    22,
    "OLMerchPspBatchType.pc"
};


static unsigned int sqlctx = 323922915;
...
{12,4130,871,0,0,
5,0,0,1,146,0,6,77,0,0,4,4,0,1,0,2,3,0,0,1,9,0,0,1,1,0,0,1,9,0,0,
};
...
void OLMerchPspBatchType(char    cdebug)
{
        cDebug = cdebug;
}
...
DEBUGLOG(("Add:create_user = [%.*s]\n",hv_create_user.len,hv_create_user.arr));
        ...
        /* EXEC SQL EXECUTE
                BEGIN
                        :hv_return_value := sp_ol_merch_psp_bat_type_ins(
...

{
        ...
        sqlstm.stmt = "begin :hv_return_value := sp_ol_merch_psp_bat_type_i\
ns ( :hv_batch_id:ind_batch_id , :hv_type:ind_type , :hv_create_user:ind_crea\
te_user ) ; END ;";
...
ERRLOG("OLMerchPspBatchType_Add: SP_OTHER_ERR TxnAbort\n");
DEBUGLOG(("Add: SP_OTHER_ERR TxnAbort\n"));
                return PD_OTHER_ERR;
        }

        if (hv_return_value == SP_ERR)  {
ERRLOG("OLMerchPspBatchType_Add: SP_ERR TxnAbort\n");
...
ERRLOG("OLMerchPspBatchType_Add: SP_INTERNAL_ERR TxnAbort\n");
