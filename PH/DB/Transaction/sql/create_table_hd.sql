...
CREATE INDEX TXN_HEADER_IDX28 ON TXN_HEADER
(TH_MERCHANT_REF)
LOGGING
TABLESPACE USER_IDX
PCTFREE    10
...
CREATE INDEX TXN_HEADER_IDX29 ON TXN_HEADER
(TH_MERCHANT_ID, TH_AR_IND, TH_SERVICE_CODE, TH_APPROVAL_TIMESTAMP, TH_NET_CCY, 
TH_TXN_ID)
LOGGING
TABLESPACE USER_IDX
...
CREATE INDEX TXN_HEADER_IDX31 ON TXN_HEADER
(TH_AR_IND, TH_TXN_CODE, TH_TXN_ID)
LOGGING
TABLESPACE USER_IDX
PCTFREE    10
INITRANS   2
...
CREATE INDEX TXN_HEADER_IDX_TEST02 ON TXN_HEADER
(TH_AR_IND, TH_TXN_CODE)
LOGGING
TABLESPACE USER_IDX
PCTFREE    10
INITRANS   2
...
CREATE INDEX TXN_HEADER_IDX_TEST08 ON TXN_HEADER
(TH_TXN_CODE, TH_CREATE_TIMESTAMP)
LOGGING
TABLESPACE USER_IDX
PCTFREE    10
INITRANS   2
...
CREATE INDEX TXN_HEADER_IDX_TEST09 ON TXN_HEADER
(TH_TXN_CODE, TH_APPROVAL_TIMESTAMP)
LOGGING
TABLESPACE USER_IDX
PCTFREE    10
INITRANS   2
