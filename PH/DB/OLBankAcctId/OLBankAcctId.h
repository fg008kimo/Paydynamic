#ifndef _OL_BANK_ACCT_ID_H_
#define _OL_BANK_ACCT_ID_H_
...
int GetNextBAIDCodeByPspId(int  *iNextCodeInNum, const char* csPspId);
...
int GetBaidByProviderCatAcctType(const char* csPspId, 
					const char* csCategory, 
					const char* csAcctType, 
					hash_t* hTxn);
...
int GetNewBAIDDetails(const char* csBAID, int iBAIDTotal, recordset_t* myRec);
