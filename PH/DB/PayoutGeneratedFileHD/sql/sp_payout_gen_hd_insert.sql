CREATE OR REPLACE FUNCTION sp_payout_gen_hd_insert(
	...
	in_txn_id		payout_generated_file_hd.fh_txn_id%type,
	in_ccy_id		payout_generated_file_hd.fh_ccy_id%type,
	in_txn_cnt		payout_generated_file_hd.fh_txn_count%type,
	in_status		payout_generated_file_hd.fh_status%type,
	in_add_user		payout_generated_file_hd.fh_create_user%type)
  RETURN NUMBER IS
