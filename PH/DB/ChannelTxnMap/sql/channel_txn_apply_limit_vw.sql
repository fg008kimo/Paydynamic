DROP VIEW CHANNEL_TXN_APPLY_LIMIT_VW;

/* Formatted on 9/13/2012 9:43:38 AM (QP5 v5.226.12202.30050) */
CREATE OR REPLACE FORCE VIEW CHANNEL_TXN_APPLY_LIMIT_VW
(
   CHANNEL,
   TXN_CODE,
   TXN_DESC,
...
AS
     SELECT ct_channel_code AS channel,
      ...
      WHERE ct_apply_limit = 1 AND tc_code = ct_txn_code
