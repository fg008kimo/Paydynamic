#ifndef _OLBANKACCTS_H_
#define _OLBANKACCTS_H_
...
int GetSupportSmsStmt(const char *csIntBankCode, const char *csBankAcctNum);
...
int GetBankAcctTypeByTxnId(const char* csTxnId, 
			  	char* csBankAcctType);
