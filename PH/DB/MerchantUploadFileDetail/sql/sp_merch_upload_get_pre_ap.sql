CREATE OR REPLACE FUNCTION sp_merch_upload_get_pre_ap(
  in_pre_id			merchant_upload_file_detail.ud_preapprove_id%type,
...
Begin
	select count(*)
	  ...
	  and	ud_preapprove_id = in_pre_id
	  and	uh_disabled=0
	  and	ud_disabled=0;
...
exception
   WHEN OTHERS THEN
     RETURN 0;
END sp_merch_upload_get_pre_ap;
/
