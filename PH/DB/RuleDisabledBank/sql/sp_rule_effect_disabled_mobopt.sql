CREATE OR REPLACE FUNCTION sp_rule_effect_disabled_mobopt (
...
Begin
 ...
 exception
   WHEN OTHERS THEN
     RETURN 9;
END sp_rule_effect_disabled_mobopt;
/
