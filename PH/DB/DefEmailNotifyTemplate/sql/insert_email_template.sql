insert into def_email_notify_template (
    et_funct, et_template, 
    et_create_user, et_update_user, et_create_timestamp, et_update_timestamp
)
values (
    'AUTO_SETT', 
...
'Approval Date/Time (GMT+8): [ARGV4] <br>' || chr(10) ||
...
'Email: AsiaPayment@OptimalPayments.com <br>' || chr(10) ||
'<br>' || chr(10) ||
...
'Dear Merchant,<br>' || chr(10) ||
'<br>' || chr(10) ||
'You have initiated a settlement request for your merchant account [ARGV2].  Please refer to the following for details.  Thank you. <br>' || chr(10) ||
'<br>' || chr(10) ||
'Transaction ID: [ARGV3] <br>' || chr(10) ||
'Request Date/Time (GMT+8): [ARGV4] <br>' || chr(10) ||
'Merchant ID: [ARGV2] <br>' || chr(10) ||
