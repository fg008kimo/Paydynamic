...
static unsigned int sqlctx = 615747;
...
{12,4130,871,0,0,
5,0,0,1,105,0,4,54,0,0,3,2,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,
32,0,0,2,68,0,4,101,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
};
...

{
        ...
        sqlstm.stmt = "select count ( 1 ) INTO :b0:b1 FROM par_def_misc WHE\
RE pdm_code = :b2 and pdm_value = :b3 and rownum = 1 ";
...

{
        ...
        sqlstm.sqladtp = &sqladt;
        sqlstm.sqltdsp = &sqltds;
        sqlstm.stmt = "select pdm_value INTO :b0:b1 FROM par_def_misc WHERE\
 pdm_code = :b2 ";
        sqlstm.iters = (unsigned int  )1;
