CREATE OR REPLACE FUNCTION sp_ol_baid_bal_in_tran_update (
   ...
   in_in_transit     ol_baid_bal.obab_in_transit%TYPE,
   in_create_user    ol_baid_bal.obab_create_user%TYPE)
   RETURN NUMBER
IS
BEGIN
   UPDATE ol_baid_bal
      SET obab_in_transit = obab_in_transit + in_in_transit,
...
EXCEPTION
   ...
   THEN
      RETURN 9;
END sp_ol_baid_bal_in_tran_update;
/
