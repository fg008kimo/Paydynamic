CREATE OR REPLACE FUNCTION sp_ol_baid_bal_prepaid_update (
   ...
   in_prepaid        ol_baid_bal.obab_prepaid%TYPE,
   in_create_user    ol_baid_bal.obab_create_user%TYPE)
   RETURN NUMBER
IS
BEGIN
   UPDATE ol_baid_bal
      SET obab_prepaid = obab_prepaid + in_prepaid,
...
EXCEPTION
   ...
   THEN
      RETURN 9;
END sp_ol_baid_bal_prepaid_update;
/
