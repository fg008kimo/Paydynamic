create or replace function sp_txn_mi_detail_insert_new(
       ...
       in_open_lien_bal                         txn_mi_detail.tm_open_lien_bal%type,
       in_lien_bal                           	txn_mi_detail.tm_lien_bal%type
	   )
  RETURN NUMBER IS
begin
...
EXCEPTION
  WHEN OTHERS THEN
     RETURN 9;
end sp_txn_mi_detail_insert_new;
/
