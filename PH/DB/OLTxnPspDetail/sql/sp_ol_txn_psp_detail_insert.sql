CREATE OR REPLACE FUNCTION sp_ol_txn_psp_detail_insert (
   ...
   in_charge_period_type	ol_txn_psp_detail.otp_charge_period_type%TYPE,
   in_pre_cal_charge		ol_txn_psp_detail.otp_pre_cal_charge%TYPE,
   in_charge_txn_created	ol_txn_psp_detail.otp_charge_txn_created%TYPE,
   in_charge_rule_id		ol_txn_psp_detail.otp_charge_rule_id%TYPE,
   in_charge_txn_id		ol_txn_psp_detail.otp_charge_txn_id%TYPE,
   in_report_date               ol_txn_psp_detail.otp_report_date%TYPE,
