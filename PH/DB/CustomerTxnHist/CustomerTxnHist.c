...
static unsigned int sqlctx = 19721099;
...
{12,4130,871,0,0,
5,0,0,1,221,0,6,97,0,0,7,7,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,4,0,
0,1,9,0,0,
};
...
struct { unsigned short len; unsigned char arr[11]; } hv_code;
...
struct { unsigned short len; unsigned char arr[11]; } hv_cust_id;
...

{
 ...
 sqlstm.stmt = "begin :hv_return_value := sp_customer_txn_hist_insert ( :hv\
_date:ind_date , :hv_merchant_id:ind_merchant_id , :hv_cust_id:ind_cust_id , \
:hv_code:ind_code , :hv_amount:ind_amount , :hv_create_user:ind_create_user )\
 ; END ;";
 ...
 sqlstm.sqhstv[3] = (unsigned char  *)&hv_cust_id;
 sqlstm.sqhstl[3] = (unsigned long )13;
 sqlstm.sqhsts[3] = (         int  )0;
 sqlstm.sqindv[3] = (         short *)&ind_cust_id;
 sqlstm.sqinds[3] = (         int  )0;
 sqlstm.sqharm[3] = (unsigned long )0;
 sqlstm.sqadto[3] = (unsigned short )0;
 sqlstm.sqtdso[3] = (unsigned short )0;
 sqlstm.sqhstv[4] = (unsigned char  *)&hv_code;
 sqlstm.sqhstl[4] = (unsigned long )13;
 sqlstm.sqhsts[4] = (         int  )0;
 sqlstm.sqindv[4] = (         short *)&ind_code;
 ...
 if (sqlca.sqlcode < 0) goto create_error;
}
