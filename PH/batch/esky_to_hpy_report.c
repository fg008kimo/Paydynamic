...
{
    21,
    "esky_to_hpy_report.pc"
};


static unsigned int sqlctx = 158883259;
...
/* Field #6 bill no*/
		...
		memcpy(&csBillNo[PD_TXN_SEQ_LEN-PD_LAST_TEN], &csList[IDX_BILL_NO][PD_TXN_SEQ_LEN-PD_LAST_TEN],PD_LAST_TEN);
