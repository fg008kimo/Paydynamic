...
static unsigned int sqlctx = 4878859;
...
*/
	...
	printf("%s%sPH Txn ID%s%sTxn Amount%s%sTxn Date%s%s\n",PD_TR,PD_TD,PD_TD_END,PD_TD,PD_TD_END,PD_TD,PD_TD_END,PD_TR_END);
