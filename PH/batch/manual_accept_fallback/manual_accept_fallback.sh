...
TMP_RESULT_FILE_1=ALL_MRN_${in_date}.result.tmp1

TMP_RESULT_FILE_2=ALL_MRN_${in_date}.result.tmp2

RESULT_FILE=ALL_MRN_${in_date}.result

cat /dev/null > ${RESULT_FILE}

find ${SRC_FILE_PATH} -name Txn*MRN*${in_date}*log|
(
	...
	do
		...
		TMP_RESULT_FILE=MRN_${in_date}_${tmp_pid}.result
