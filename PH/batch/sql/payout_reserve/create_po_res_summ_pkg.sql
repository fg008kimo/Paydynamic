...
IS
   ...
   IS
      ...
      v_merchant_short_name     merch_detail.short_name%type;
      ...
      v_week_res_amt       merchant_reserved_amt.mr_reserved_amount%type;
      v_week_effect_date   merchant_reserved_amt.mr_effect_date%type;
      
      v_tmp_remain_res_amt  merchant_reserved_amt.mr_remain_reserved_amount%type;
      v_sun_remain_res_amt  merchant_reserved_amt.mr_remain_reserved_amount%type;
      v_mon_remain_res_amt  merchant_reserved_amt.mr_remain_reserved_amount%type;
      v_tue_remain_res_amt  merchant_reserved_amt.mr_remain_reserved_amount%type;
      v_wed_remain_res_amt  merchant_reserved_amt.mr_remain_reserved_amount%type;
      v_thu_remain_res_amt  merchant_reserved_amt.mr_remain_reserved_amount%type;
      v_fri_remain_res_amt  merchant_reserved_amt.mr_remain_reserved_amount%type;
      v_sat_remain_res_amt  merchant_reserved_amt.mr_remain_reserved_amount%type;
      v_week_remain_res_amt  merchant_reserved_amt.mr_remain_reserved_amount%type;
   ...
   BEGIN
      ...
      LOOP
         ...
         for v_day_of_week in 0..7 loop
             v_tmp_res_amt     := NULL;
             v_tmp_effect_date := NULL;
             v_tmp_remain_res_amt     := NULL;

             begin
                 select mr_reserved_amount, mr_effect_date, mr_remain_reserved_amount
             ...
             if (v_day_of_week = 0) then
                 ...
                 v_week_res_amt       := v_tmp_res_amt;
                 v_week_effect_date   := v_tmp_effect_date;
                 v_week_remain_res_amt := v_tmp_remain_res_amt;
             end if;
         end loop;
         ...
         result (n) :=
            PO_RES_SUMM_OBJ(v_client_id,
                            ...
                            v_week_res_amt,
                            v_week_remain_res_amt,
                            to_char(v_week_effect_date, 'YYYYMMDDHH24MISS')
			   );
      END LOOP;
