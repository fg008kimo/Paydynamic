DROP VIEW TEST_MERCHANT_BALANCE_VIEW;

CREATE OR REPLACE FORCE VIEW TEST_MERCHANT_BALANCE_VIEW
(
   M_MERCHANT_ID,
   M_CURRENCY_ID,
   M_COUNTRY_ID,
                  ...
                  CASE
                     ...
                     THEN
                          floor(((m_current_bal
                           - m_total_float
                           - m_total_hold
                           - m_total_float_after_payout) / (1 + rate))*100)/100
                     WHEN NVL (mr_remain_reserved_amount, 0) = 0
                     THEN
                        floor((NVL(mr_remain_reserved_amount, 0) / (1 + rate))*100)/100
                     WHEN (m_current_bal
                           - m_total_float
                           - m_total_hold
                           - m_total_float_after_payout) >
