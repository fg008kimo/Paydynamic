...
IS
   ...
   IS
      ...
      v_current_bal_settlement	txn_detail.td_current_bal_settlement%TYPE;
      v_total_float		txn_detail.td_total_float%TYPE;
      v_total_float_payout	txn_detail.td_total_float_after_payout%TYPE;
      v_total_float_settlement	txn_detail.td_total_float_settlement%TYPE;
      v_total_reserve_amount	txn_detail.td_total_reserved_amount%TYPE;
      v_fundin_payout		txn_detail.td_fundin_payout%TYPE;
      v_reserved_payout		txn_detail.td_reserved_payout%TYPE;
      v_total_hold		txn_detail.td_total_hold%TYPE;
      v_total_hold_settlement	txn_detail.td_total_hold_settlement%TYPE;
      ...
      LOOP
         ...
         result (n) :=
            RPT009_OBj (v_merchant_id,
                        ...
                        (v_total_float + v_total_float_payout + v_total_float_settlement),/* float bal */
                        (v_fundin_payout),/* fund in for payout */
                        (v_current_bal + v_current_bal_settlement - v_total_hold - v_total_hold_settlement - v_total_reserve_amount),/* current bal */
                        (v_reserved_payout),/* reserved bal */
                        (v_total_hold + v_total_hold_settlement),/* holdback bal */
                        (v_current_bal + v_current_bal_settlement),/* merchant bal */
                        v_currency,
                        v_status);
      END LOOP;
