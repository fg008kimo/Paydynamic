...
IS
   FUNCTION F_MERCHANT_TXN_HISTORY (
      ...
      in_merchant_id_list           VARCHAR2, --TXN_HEADER.TH_MERCHANT_ID%TYPE,
      ...
      in_txn_code_list              VARCHAR2,         --TXN_CODE.TC_CODE%TYPE,
...
IS
   ...
   IS
      ...
      v_remark                       TXN_REMARKS.tr_remark%TYPE;
      ...
      v_final_mer_received_net_amt   MERCHANT_SETTLEMENT_DETAIL.sd_receive_net_amt%TYPE;
      v_final_mer_received_net_ccy   MERCHANT_SETTLEMENT_DETAIL.sd_receive_net_ccy%TYPE;
      ...
      v_psp_cost_amt                 TXN_ELEMENTS.te_amount%TYPE;
      v_psp_cost_amt_ccy             TXN_ELEMENTS.te_ccy%TYPE;
      v_payout_acct_num              MERCHANT_UPLOAD_FILE_DETAIL.ud_account_num%TYPE;
      v_markup_amt                   TXN_HEADER.th_transaction_amount%TYPE;
      v_markup_amt_ccy               CURRENCY.currency_id%TYPE;
      v_beneficiary_bank_ac_num      MERCHANT_SETTLEMENT_DETAIL.sd_beneficiary_bank_ac_num%TYPE;
      v_beneficiary_bank_name        MERCHANT_SETTLEMENT_DETAIL.sd_beneficiary_bank_name%TYPE;
      v_beneficiary_bank_ac_name     MERCHANT_SETTLEMENT_DETAIL.sd_beneficiary_bank_ac_name%TYPE;
      v_address			     MERCHANT_SETTLEMENT_DETAIL.sd_address%TYPE;
      v_swift_code		     MERCHANT_SETTLEMENT_DETAIL.sd_swift_code%TYPE;
      v_iban			     MERCHANT_SETTLEMENT_DETAIL.sd_iban%TYPE;
      v_bank_ac_ccy		     MERCHANT_SETTLEMENT_DETAIL.sd_bank_ac_ccy%TYPE;
      v_consumer_deposit_bank BANK_DESC.bank_name%TYPE;
         ...
         SELECT transaction_id,
           ...
           FROM (                                                   -- deposit
                 SELECT th_txn_id AS transaction_id,
                        ...
                        DECODE (
                           ...
                           'DSI', DECODE (
                                     ...
                                     'I', 0,
                                     'W', 0,
                                     th_net_amount + NVL (tfee.te_amount, 0)),
                           0)
                           AS mer_received_amt,
                        DECODE (
                           th_txn_code,
                        ...
                        DECODE (
                           ...
                           'RDS', th_net_amount + NVL (tfee.te_amount, 0),
                           0)
                           AS mer_paid_amount,
                        DECODE (th_txn_code,
                                'VDS', th_net_ccy,
                        ...
                        td_customer_id AS cust_id,
                        td_txn_gp_id AS txn_gp_id,
                        DECODE (th_txn_code,
                                'DSI', psp_cost.te_amount,
                                'VDS', psp_cost.te_amount,
                                0)
                           AS psp_cost_amt,
                        DECODE (th_txn_code,
                                'DSI', psp_cost.te_ccy,
                        ...
                        '' AS payout_acct_num,
                        mamt.te_amount AS markup_amt,
                        mamt.te_ccy AS markup_amt_ccy,
                        NULL AS beneficiary_bank_ac_num,
                        NULL AS beneficiary_bank_name,
                        NULL AS beneficiary_bank_ac_name,
                        NULL AS address,
                        NULL AS swift_code,
                        NULL AS iban,
                        NULL AS bank_ac_ccy,
                        bank_desc.bank_name AS consumer_deposit_bank
                   FROM (SELECT th_txn_id,
                          ...
                          WHERE     (    th_status = dm_status
                                ...
                                AND th_txn_id = NVL (in_txn_id, th_txn_id)
                                AND (   in_min_amount <=
                                           th_transaction_amount
                                ...
                                AND (   th_merchant_id IN (    SELECT REGEXP_SUBSTR (
                                                                         in_merchant_id_list,
                                                                         '[^,]+',
                                                                         1,
                                                                         LEVEL)
                                ...
                                AND (    th_txn_code IN ('DSI', 'VDS', 'VDR', 'RDS')
                                     AND (   th_txn_code IN (    SELECT REGEXP_SUBSTR (
                                                                           in_txn_code_list,
                                                                           '[^,]+',
                                                                           1,
                                                                           LEVEL)
                        ...
                        LEFT JOIN txn_elements holdback
                           ON     th_txn_id = holdback.te_txn_id
                              AND holdback.te_txn_element_type = 'RAMT'
                              AND holdback.te_party_type = 'M'
                        LEFT JOIN txn_elements psp_cost
                           ON     th_txn_id = psp_cost.te_txn_id
                              AND psp_cost.te_txn_element_type = 'TFEE'
                              AND psp_cost.te_party_type = 'P'
                        LEFT JOIN txn_elements mamt
                           ON     th_txn_id = mamt.te_txn_id
                              AND mamt.te_txn_element_type = 'MAMT'
                        LEFT JOIN txn_psp_detail ON th_txn_id = tp_txn_id,
                        TXN_DETAIL
                        LEFT JOIN bank_desc
                           ON td_bank_code = internal_bank_code,
                        merch_detail,
                        txn_code
                  WHERE     th_txn_id = td_txn_id
                        ...
                        AND th_txn_code = txn_code.tc_code
                        AND txn_code.tc_merchant_fe_display = 1
                 ...
                 SELECT th_txn_id AS transaction_id,
                        ...
                        th_create_timestamp AS create_timestamp,
                        th_approval_timestamp AS approval_timestamp,
                        NVL (cancel_remarks.tr_remark, req_remarks.tr_remark)
                           AS remark,
                        th_transaction_amount AS mer_request_amt,
                        td_txn_ccy AS mer_request_ccy,
                        ...
                        DECODE (
                           dm_status_desc,
                           'Approved',   th_transaction_amount
                                       - NVL (tfee.te_amount, 0),
                           NULL)
                           AS mer_receivable_net_amt,
                        DECODE (dm_status_desc, 'Approved', td_txn_ccy, NULL)
                           AS mer_receivable_net_amt_ccy,
                        ...
                        '' AS cust_id,
                        NULL AS txn_gp_id,
                        psp_cost.te_amount AS psp_cost_amt,
                        psp_cost.te_ccy AS psp_cost_amt_ccy,
                        NVL (sd_receive_net_amt, 0)
                           AS final_mer_received_net_amt,
                        sd_receive_net_ccy AS final_mer_received_net_amt_ccy,
                        '' AS payout_acct_num,
                        mamt.te_amount AS markup_amt,
                        mamt.te_ccy AS markup_amt_ccy,
                        CASE WHEN txn_header.th_status = 'C' and txn_header.th_ar_ind = 'A' then merchant_settlement_detail.sd_beneficiary_bank_ac_num else client_sett_bank.bank_ac_nmb END AS beneficiary_bank_ac_num,
                        CASE WHEN txn_header.th_status = 'C' and txn_header.th_ar_ind = 'A' then merchant_settlement_detail.sd_beneficiary_bank_name else client_sett_bank.bank_name END AS beneficiary_bank_name,
                        CASE WHEN txn_header.th_status = 'C' and txn_header.th_ar_ind = 'A' then merchant_settlement_detail.sd_beneficiary_bank_ac_name else client_sett_bank.bank_ac_name END AS beneficiary_bank_ac_name,
                        CASE WHEN txn_header.th_status = 'C' and txn_header.th_ar_ind = 'A' then merchant_settlement_detail.sd_address else client_sett_bank.address END AS address,
                        CASE WHEN txn_header.th_status = 'C' and txn_header.th_ar_ind = 'A' then merchant_settlement_detail.sd_swift_code else client_sett_bank.swift_code END AS swift_code,
                        CASE WHEN txn_header.th_status = 'C' and txn_header.th_ar_ind = 'A' then merchant_settlement_detail.sd_iban else client_sett_bank.iban END AS iban,
                        CASE WHEN txn_header.th_status = 'C' and txn_header.th_ar_ind = 'A' then merchant_settlement_detail.sd_bank_ac_ccy else client_sett_bank.currency_id END AS bank_ac_ccy,
                        NULL AS consumer_deposit_bank
                   FROM (SELECT th_txn_id,
                                th_service_code,
                                th_merchant_id,
                                th_txn_code,
                        ...
                        LEFT JOIN client_sett_bank
                           ON client_sett_bank.client_sett_bank_id =
                                 merchant_settlement_detail.sd_client_sett_bank_id
                        LEFT JOIN txn_remarks req_remarks
                           ON     sd_txn_id = req_remarks.tr_txn_id
                              AND req_remarks.tr_sub_status IN ('124', '125')
                        LEFT JOIN txn_remarks cancel_remarks
                           ON     sd_txn_id = cancel_remarks.tr_txn_id
                              AND cancel_remarks.tr_sub_status IN ('110',
                                                                   '111',
                                                                   '139'),
                        txn_detail,
                        merch_detail,
                 ...
                 SELECT th_txn_id AS transaction_id,
                        ...
                        DECODE (
                           th_txn_code,
                           'POA', th_net_amount - NVL (tfee.te_amount, 0),
                           0)
                           AS mer_payable_amount,
                        DECODE (th_txn_code, 'POA', th_net_ccy, '')
                           AS mer_payable_ccy,
                        DECODE (th_txn_code,
                                'POA', NVL (ud_payout_amount, 0),
                                0)
                        ...
                        NULL AS txn_gp_id,
                        DECODE (th_txn_code,
                                'POA', psp_cost.te_amount,
                                'VOA', psp_cost.te_amount,
                                0)
                           AS psp_cost_amt,
                        DECODE (th_txn_code,
                                'POA', psp_cost.te_ccy,
                        ...
                        0 AS final_mer_received_net_amt,
                        '' AS final_mer_received_net_amt_ccy,
                        ud_account_num AS payout_acct_num,
                        mamt.te_amount AS markup_amt,
                        mamt.te_ccy AS markup_amt_ccy,
                        NULL AS beneficiary_bank_ac_num,
                        NULL AS beneficiary_bank_name,
                   ...
                   FROM (SELECT th_txn_id,
                        ...
                        LEFT JOIN txn_elements tfee
                           ON     th_txn_id = tfee.te_txn_id
                              AND tfee.te_txn_element_type in ('TFEE','MAPF')
                              AND tfee.te_party_type = 'M'
                        LEFT JOIN txn_elements psp_cost
                           ON     th_txn_id = psp_cost.te_txn_id
                              AND psp_cost.te_txn_element_type = 'TFEE'
                        ...
                        LEFT JOIN txn_elements mamt
                           ON     th_txn_id = mamt.te_txn_id
                              AND mamt.te_txn_element_type = 'MAMT'
                        LEFT JOIN merchant_upload_file_detail
                           ON DECODE (th_txn_code,
                                      'POA', th_txn_id,
                                      th_org_txn_id) = ud_txn_id,
                        txn_detail
                 ...
                 SELECT th_txn_id AS transaction_id,
                        ...
                        '' AS consumer_paid_ccy,
                        DECODE (th_txn_code,
                                'UOD', th_transaction_amount,
                                '')
                           AS mer_received_amt,
                        DECODE (th_txn_code, 'UOD', td_txn_ccy, '')
                           AS mer_received_ccy,
                        ...
                        '' AS mer_received_net_amt_ccy,
                        DECODE (th_txn_code,
                                'HOD', th_transaction_amount,
                                '')
                           AS mer_payable_amount,
                        DECODE (th_txn_code, 'HOD', td_txn_ccy, '')
                           AS mer_payable_ccy,
                        0 AS consumer_received_amt,
                        '' AS consumer_received_ccy,
                        DECODE (th_txn_code,
                        ...
                        th_transaction_amount AS transaction_amount,
                        td_txn_ccy AS transaction_ccy,
                        NVL (th_net_amount, th_transaction_amount)
                           AS net_amount,
                        NVL (th_net_ccy, td_txn_ccy) AS net_ccy,
                        th_merchant_id AS merchant_id,
                        th_client_id AS client_id,
                        th_status,
                        th_ar_ind AS ar_ind,
                 ...
                 SELECT th_txn_id AS transaction_id,
                        ...
                        '' AS mer_receivable_net_amt_ccy,
                        NULL AS tp_bank_code,
                        th_reserve_amount AS transaction_amount,
                        td_txn_ccy AS transaction_ccy,
                        th_reserve_amount AS net_amount,
                        th_net_ccy AS net_ccy,
                        th_merchant_id AS merchant_id,
                        th_client_id AS client_id,
                        th_status,
                   ...
                   FROM (SELECT th_txn_id,
                          ...
                          WHERE     (    th_status = dm_status
                                ...
                                AND (   th_client_id = in_client_id
                                     OR in_client_id IS NULL)
                                AND (    th_txn_code IN ('RLR', 'HBR', 'VHB')
                                     AND (   th_txn_code IN (    SELECT REGEXP_SUBSTR (
                                                                           in_txn_code_list,
                                                                           '[^,]+',
                                                                           1,
                 ...
                 SELECT th.th_txn_id AS transaction_id,
                        ...
                        NULL AS txn_gp_id,
                        DECODE (th_txn_code,
                                'OTM', psp_cost.te_amount,
                                'MTO', psp_cost.te_amount,
                                0)
                           AS psp_cost_amt,
                        DECODE (th_txn_code,
                                'OTM', psp_cost.te_ccy,
                   ...
                   FROM (SELECT th_txn_id,
                        ...
                        LEFT JOIN
                        (SELECT th_txn_id, th_transaction_amount
                           FROM txn_header) oth
                        ...
                        LEFT JOIN txn_elements tfee
                           ON     th.th_txn_id = tfee.te_txn_id
                              ...
                              AND tfee.te_party_type = 'M'
                        LEFT JOIN txn_elements psp_cost
                           ON     th.th_txn_id = psp_cost.te_txn_id
                              AND psp_cost.te_txn_element_type = 'TFEE'
                              AND psp_cost.te_party_type = 'P'
                        LEFT JOIN txn_elements mamt
                           ON     th.th_txn_id = mamt.te_txn_id
                              AND mamt.te_txn_element_type = 'MAMT',
                        txn_detail td,
                        merch_detail,
                        txn_code
                 ...
                 SELECT th_txn_id AS transaction_id,
                  ...
                  WHERE     th_txn_id = td_txn_id
                        ...
                        AND th_txn_code = txn_code.tc_code
                        AND txn_code.tc_merchant_fe_display = 1)
          WHERE     (   th_txn_code IN (    SELECT REGEXP_SUBSTR (
                                                      in_txn_code_list,
                                                      '[^,]+',
                                                      1,
                                                      LEVEL)
