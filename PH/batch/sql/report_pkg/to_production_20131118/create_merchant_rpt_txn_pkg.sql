         ...
         SELECT transaction_id,
           ...
           FROM (                                                   -- deposit
                 SELECT th_txn_id AS transaction_id,
                        ...
                        '' AS cust_id,
                        NULL AS txn_gp_id,
                        DECODE (th_txn_code, 'DSI', psp_cost.te_amount,
                                             'VDS', psp_cost.te_amount,
                                             0)
                           AS psp_cost_amt,
                        DECODE (th_txn_code, 'DSI', psp_cost.te_ccy,
                                             'VDS', psp_cost.te_ccy,
                                             '')
                           AS psp_cost_amt_ccy
                 ...
                 SELECT th_txn_id AS transaction_id,
                        ...
                        '' AS cust_id,
                        NULL AS txn_gp_id,
                        DECODE (th_txn_code, 'POA', psp_cost.te_amount,
                                             'VOA', psp_cost.te_amount,
                                             0)
                           AS psp_cost_amt,
                        DECODE (th_txn_code, 'POA', psp_cost.te_ccy,
                                             'VOA', psp_cost.te_ccy,
                                             '')
                           AS psp_cost_amt_ccy
                   FROM (SELECT th_txn_id,
