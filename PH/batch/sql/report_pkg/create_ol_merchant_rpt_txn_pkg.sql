...
IS
   ...
   IS
      ...
      v_beneficiary_bank_ac_num      ol_merchant_settlement_detail.osd_beneficiary_bank_ac_num%TYPE;
      v_beneficiary_bank_name        ol_merchant_settlement_detail.osd_beneficiary_bank_name%TYPE;
         ...
         SELECT transaction_id,
           ...
           FROM (                                                   -- deposit
                 ...
                 SELECT oth_txn_id AS transaction_id,
                        ...
                        oth_ex_rate AS ex_rate,
                        oth_upload_channel AS upload_channel,
                        CASE WHEN ol_txn_header.oth_status = 'C' and ol_txn_header.oth_ar_ind = 'A' then ol_merchant_settlement_detail.osd_beneficiary_bank_ac_num else client_sett_bank.bank_ac_nmb END AS beneficiary_bank_ac_num,
                        CASE WHEN ol_txn_header.oth_status = 'C' and ol_txn_header.oth_ar_ind = 'A' then ol_merchant_settlement_detail.osd_beneficiary_bank_name else client_sett_bank.bank_name END AS beneficiary_bank_name
                   FROM (SELECT oth_txn_id,
                                oth_service_code,
                                oth_merchant_id,
                                oth_txn_code,
                        ...
                        LEFT JOIN client_sett_bank
                           ON client_sett_bank.client_sett_bank_id = ol_merchant_settlement_detail.osd_client_sett_bank_id
                 ...
                 SELECT oth_txn_id AS transaction_id,
                   ...
                   FROM (SELECT oth_txn_id,
                        ...
                        LEFT JOIN ol_txn_elements tfee
                           ON     oth_txn_id = tfee.ote_txn_id
                              AND tfee.ote_txn_element_type in ('TFEE','MAPF')
                              AND tfee.ote_party_type = 'M'
                 ...
                 -- release expired holdback
                                  SELECT oth_txn_id AS transaction_id,
                                         ...
                                         0 AS consumer_paid_amt,
                                         '' AS consumer_paid_ccy,
                                         oth_reserve_amount AS mer_received_amt,
                                         ...
                                         '' AS mer_receivable_net_amt_ccy,
                                         NULL AS otp_bank_code,
                                         oth_reserve_amount AS transaction_amount,
                                         otd_txn_ccy AS transaction_ccy,
                                         oth_reserve_amount AS net_amount,
                                         oth_net_ccy AS net_ccy,
                                         oth_merchant_id AS merchant_id,
                                         oth_client_id AS client_id,
                                         oth_status,
