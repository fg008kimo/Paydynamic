DROP VIEW CRR_DEPOSIT_COST_ADJ_VIEW;

CREATE OR REPLACE FORCE VIEW CRR_DEPOSIT_COST_ADJ_VIEW
(
   CR_TXN_DATE,
   CR_COUNTRY,
   CR_PRODUCT,
       ...
       FROM (SELECT TH_TXN_ID,
              ...
              WHERE     TH_STATUS IN ('C', 'R')
                    ...
                    AND TH_TXN_CODE = (SELECT SP_VAL
                                        ...
                                        WHERE SP_CODE = 'CREDIT_ADJ_FOR_RECON')
     ...
     SELECT TH_APPROVAL_DATE,
       ...
       FROM (SELECT TH_TXN_ID,
              ...
              WHERE     TH_STATUS IN ('C', 'R')
                    ...
                    AND TH_TXN_CODE = (SELECT SP_VAL
                                         FROM SYSTEM_PARAMETER
                                        WHERE SP_CODE = 'DEBIT_ADJ_FOR_RECON')
                    AND TH_APPROVAL_DATE IS NOT NULL),
            TXN_DETAIL,
            TXN_PSP_DETAIL,
            PSP_DETAIL,
