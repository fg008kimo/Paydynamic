DROP VIEW CRR_APL_MBT_2_OFF_VIEW;

CREATE OR REPLACE FORCE VIEW CRR_APL_MBT_2_OFF_VIEW
(
   TH_TXN_ID,
   CR_TXN_DATE,
   CR_COUNTRY,
       ...
       FROM (SELECT TH_TXN_ID,
            ...
            (SELECT TE_TXN_ID,
              ...
              WHERE     TE_PARTY_TYPE = 'M'
                    AND TE_TXN_ELEMENT_TYPE IN ('TAMT', 'TFEE')),
            ...
            (SELECT CR_COUNTRY_ID,
              ...
              WHERE     CR_PARTY_TYPE = 'M'
                    AND CR_TXN_CODE = 'MTO'
                    AND CR_JNL_ENTRY_TYPE_ID = 'S_TXN_AMT'
                    AND CR_DISABLED = 0)
     ...
     SELECT TH_TXN_ID,
       ...
       FROM (SELECT TH_TXN_ID,
            ...
            (SELECT TE_TXN_ID,
                    ...
                    TE_PARTY_TYPE
               FROM TXN_ELEMENTS
              WHERE TE_PARTY_TYPE = 'M' AND TE_TXN_ELEMENT_TYPE IN ('TFEE')),
            (SELECT PM_MERCHANT_ID,
                    PM_SERVICE_CODE,
                    PM_COUNTRY,
                    PM_PRODUCT_CODE
     ...
     SELECT TH_TXN_ID,
       ...
       FROM (SELECT TH_TXN_ID,
            ...
            (SELECT TE_TXN_ID,
                    ...
                    TE_PARTY_TYPE
               FROM TXN_ELEMENTS
              WHERE TE_PARTY_TYPE in ('R', 'M') AND TE_TXN_ELEMENT_TYPE IN ('MAMT')),
            (SELECT PM_MERCHANT_ID,
                    PM_SERVICE_CODE,
                    PM_COUNTRY,
                    PM_PRODUCT_CODE
     ...
     SELECT TH_TXN_ID,
       ...
       FROM (SELECT TH_TXN_ID,
            ...
            (SELECT TE_TXN_ID,
                    ...
                    TE_PARTY_TYPE
               FROM TXN_ELEMENTS
              WHERE TE_PARTY_TYPE = 'M' AND TE_TXN_ELEMENT_TYPE IN ('TAMT')),
            (SELECT PM_MERCHANT_ID,
                    PM_SERVICE_CODE,
                    PM_COUNTRY,
                    PM_PRODUCT_CODE
