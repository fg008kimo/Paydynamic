...
{
    26,
    "sim_card_monthly_report.pc"
};


static unsigned int sqlctx = 1051336123;
...
extern void sqliem( unsigned char *, signed int * );
 ...
 static char *sq0001 = 
"SELECT TO_CHAR ( TRUNC ( SYSDATE ) , 'YYYYMMDD' ) , TO_CHAR ( TRUNC ( SYSDA\
TE ) + 30 , 'YYYYMMDD' ) , TO_CHAR ( LAST_DAY ( TRUNC ( SYSDATE ) ) , 'YYYYMM\
DD' ) FROM DUAL            ";
...
{12,4130,871,0,0,
5,0,0,1,179,0,9,113,0,2049,0,0,0,1,0,
20,0,0,1,0,0,13,115,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
47,0,0,1,0,0,15,126,0,0,0,0,0,1,0,
62,0,0,2,770,0,9,180,0,2049,2,2,0,1,0,1,9,0,0,1,9,0,0,
85,0,0,2,0,0,13,182,0,0,9,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,2,9,0,0,2,9,0,0,
136,0,0,2,0,0,15,238,0,0,0,0,0,1,0,
151,0,0,3,736,0,9,303,0,2049,2,2,0,1,0,1,9,0,0,1,9,0,0,
174,0,0,3,0,0,13,305,0,0,9,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,
0,0,2,9,0,0,2,9,0,0,2,9,0,0,
225,0,0,3,0,0,15,361,0,0,0,0,0,1,0,
240,0,0,1,0,0,15,410,0,0,0,0,0,1,0,
255,0,0,2,0,0,15,411,0,0,0,0,0,1,0,
270,0,0,3,0,0,15,412,0,0,0,0,0,1,0,
285,0,0,4,0,0,32,413,0,0,0,0,0,1,0,
};
...
struct { unsigned short len; unsigned char arr[9]; } v_curr_day_date;

		/* varchar v_curr_day_plus_thirty_day_date[PD_DATE_LEN+1]; */ 
struct { unsigned short len; unsigned char arr[9]; } v_curr_day_plus_thirty_day_date;

		/* varchar v_month_end_date[PD_DATE_LEN+1]; */ 
struct { unsigned short len; unsigned char arr[9]; } v_month_end_date;

		/* varchar v_alert_date[PD_DATE_LEN+1]; */ 
struct { unsigned short len; unsigned char arr[9]; } v_alert_date;

		/* varchar	v_sim_nature[PD_ACCT_TYPE_LEN+1]; */ 
struct { unsigned short len; unsigned char arr[4]; } v_sim_nature;
...

{
  ...
  sqlstm.sqhstv[0] = (unsigned char  *)&v_curr_day_date;
  sqlstm.sqhstl[0] = (unsigned long )11;
  sqlstm.sqhsts[0] = (         int  )0;
  sqlstm.sqindv[0] = (         short *)&ind_curr_day_date;
  sqlstm.sqinds[0] = (         int  )0;
  sqlstm.sqharm[0] = (unsigned long )0;
  sqlstm.sqadto[0] = (unsigned short )0;
  sqlstm.sqtdso[0] = (unsigned short )0;
  sqlstm.sqhstv[1] = (unsigned char  *)&v_curr_day_plus_thirty_day_date;
  sqlstm.sqhstl[1] = (unsigned long )11;
  sqlstm.sqhsts[1] = (         int  )0;
  sqlstm.sqindv[1] = (         short *)&ind_curr_day_plus_thirty_day_date;
  sqlstm.sqinds[1] = (         int  )0;
  sqlstm.sqharm[1] = (unsigned long )0;
  sqlstm.sqadto[1] = (unsigned short )0;
  sqlstm.sqtdso[1] = (unsigned short )0;
  sqlstm.sqhstv[2] = (unsigned char  *)&v_month_end_date;
  sqlstm.sqhstl[2] = (unsigned long )11;
  sqlstm.sqhsts[2] = (         int  )0;
  sqlstm.sqindv[2] = (         short *)&ind_month_end_date;
...

{
 ...
 sqlstm.occurs = (unsigned int  )0;
 sqlstm.sqcmod = (unsigned int )0;
 sqlstm.sqhstv[0] = (unsigned char  *)&v_alert_date;
 sqlstm.sqhstl[0] = (unsigned long )11;
 sqlstm.sqhsts[0] = (         int  )0;
 ...
 sqlstm.sqadto[0] = (unsigned short )0;
 sqlstm.sqtdso[0] = (unsigned short )0;
 sqlstm.sqhstv[1] = (unsigned char  *)&v_sim_nature;
