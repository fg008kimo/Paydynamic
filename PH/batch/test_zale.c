...
static unsigned int sqlctx = 328867;
...
{12,4130,871,0,0,
5,0,0,1,88,0,4,1566,0,0,1,0,0,1,0,2,3,0,0,
};
...

{
 ...
 sqlstm.stmt = "select COUNT ( * ) INTO :b0:b1 FROM DEF_PRODUCT WHERE DP_ID\
 = 'ABC' AND DP_DISABLED = 0 ";
