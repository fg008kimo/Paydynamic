...
static unsigned int sqlctx = 312171;
...
extern void sqliem( unsigned char *, signed int * );
 ...
 static char *sq0002 = 
"select pc_category ,pc_txn_code ,pc_reversal_txn_code ,pc_reversal_fee_txn_\
code  from par_category where pc_sequence_type_name=:b0           ";
...
eset_ph_pid=psp_detail.psp_id) and psp_detail.psp_id=psp_country.psp_id)     \
 ...
 static char *sq0009 = 
"select bc_int_bank_code  from (select bc_int_bank_code  from par_int_bank_c\
ode_map where (bc_bank_name=:b0 and decode(bc_special_psp_channel,:b1,:b2,bc_\
special_psp_channel)=:b2) order by decode(bc_special_psp_channel,:b1,9999,1) \
) where rownum=1           ";
...
ud_country ,ud_payout_amount ,ud_request_amount ,ud_request_currency ,ud_payo\
ut_currency ,ud_merchant_fee_ccy ,ud_merchant_fee ,ud_markup_ccy ,ud_markup_a\
mt ,ud_exchange_rate ,ud_bank_name ,ud_bank_code ,ud_branch ,ud_account_num ,\
ud_account_name  from merchant_upload_file_detail where ud_vnc_ref_num=:b0 or\
der by ud_txn_id            ";
...
ud_bank_name ,ud_bank_code ,ud_branch ,ud_account_num ,ud_account_name  from \
merchant_upload_file_detail where ud_aux_txn_id=:b0 order by ud_batch_id,ud_s\
eq_num            ";
...
0           ";
 ...
 static char *sq0021 = 
"select client_id ,name ,short_name ,disabled ,status ,approximate_fee_rate \
,allow_reserved ,release_reserved_period ,allow_payout_dup_merch_ref ,settlem\
ent_process_period ,ignore_nack  from merch_detail where merchant_id=:b0     \
      ";

 static char *sq0022 = 
"select business_type ,client_name ,status  from clients where client_id=:b0\
           ";
...
{12,4130,871,0,0,
5,0,0,1,66,0,4,52,0,0,2,1,0,1,0,2,9,0,0,1,9,0,0,
28,0,0,2,141,0,9,112,0,0,1,1,0,1,0,1,9,0,0,
47,0,0,2,0,0,13,114,0,0,4,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
78,0,0,2,0,0,15,157,0,0,0,0,0,1,0,
93,0,0,2,0,0,15,172,0,0,0,0,0,1,0,
108,0,0,3,104,0,9,389,0,0,1,1,0,1,0,1,9,0,0,
127,0,0,3,0,0,13,391,0,0,1,0,0,1,0,2,9,0,0,
146,0,0,3,0,0,15,411,0,0,0,0,0,1,0,
161,0,0,3,0,0,15,420,0,0,0,0,0,1,0,
176,0,0,4,175,0,9,466,0,0,1,1,0,1,0,1,9,0,0,
195,0,0,4,0,0,13,468,0,0,4,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
226,0,0,4,0,0,15,516,0,0,0,0,0,1,0,
241,0,0,4,0,0,15,528,0,0,0,0,0,1,0,
256,0,0,5,84,0,4,555,0,0,2,1,0,1,0,2,3,0,0,1,9,0,0,
279,0,0,6,0,0,17,653,0,0,1,1,0,1,0,1,9,0,0,
298,0,0,6,0,0,21,654,0,0,0,0,0,1,0,
313,0,0,6,0,0,17,702,0,0,1,1,0,1,0,1,9,0,0,
332,0,0,6,0,0,21,703,0,0,0,0,0,1,0,
347,0,0,7,341,0,4,795,0,0,6,1,0,1,0,2,9,0,0,2,1,0,0,2,1,0,0,2,9,0,0,2,9,0,0,1,
9,0,0,
386,0,0,6,0,0,17,898,0,0,1,1,0,1,0,1,9,0,0,
405,0,0,6,0,0,21,899,0,0,0,0,0,1,0,
420,0,0,8,235,0,9,957,0,0,1,1,0,1,0,1,9,0,0,
439,0,0,8,0,0,13,959,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
466,0,0,8,0,0,15,990,0,0,0,0,0,1,0,
481,0,0,8,0,0,15,999,0,0,0,0,0,1,0,
496,0,0,9,256,0,9,1052,0,0,5,5,0,1,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
531,0,0,9,0,0,13,1054,0,0,1,0,0,1,0,2,9,0,0,
550,0,0,9,0,0,15,1070,0,0,0,0,0,1,0,
565,0,0,9,0,0,15,1079,0,0,0,0,0,1,0,
580,0,0,10,113,0,9,1130,0,0,2,2,0,1,0,1,1,0,0,1,9,0,0,
603,0,0,10,0,0,13,1132,0,0,3,0,0,1,0,2,1,0,0,2,9,0,0,2,3,0,0,
630,0,0,10,0,0,15,1172,0,0,0,0,0,1,0,
645,0,0,10,0,0,15,1187,0,0,0,0,0,1,0,
660,0,0,11,151,0,6,1240,0,0,4,4,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
691,0,0,12,74,0,9,1313,0,0,1,1,0,1,0,1,9,0,0,
710,0,0,12,0,0,13,1315,0,0,1,0,0,1,0,2,9,0,0,
729,0,0,12,0,0,15,1338,0,0,0,0,0,1,0,
744,0,0,12,0,0,15,1349,0,0,0,0,0,1,0,
759,0,0,13,154,0,9,1410,0,0,2,2,0,1,0,1,9,0,0,1,3,0,0,
782,0,0,13,0,0,13,1412,0,0,1,0,0,1,0,2,9,0,0,
801,0,0,13,0,0,15,1434,0,0,0,0,0,1,0,
816,0,0,13,0,0,15,1445,0,0,0,0,0,1,0,
831,0,0,14,411,0,9,1539,0,0,1,1,0,1,0,1,9,0,0,
850,0,0,14,0,0,13,1541,0,0,20,0,0,1,0,2,68,0,0,2,3,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,2,4,0,0,2,4,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,9,0,0,2,4,0,0,2,4,0,
0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
945,0,0,14,0,0,15,1710,0,0,0,0,0,1,0,
960,0,0,14,0,0,15,1720,0,0,0,0,0,1,0,
975,0,0,15,401,0,9,1810,0,0,1,1,0,1,0,1,9,0,0,
994,0,0,15,0,0,13,1812,0,0,19,0,0,1,0,2,68,0,0,2,3,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,4,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,4,0,0,2,9,0,0,2,4,0,0,2,4,0,0,2,3,0,0,2,9,0,
0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
1085,0,0,15,0,0,15,1977,0,0,0,0,0,1,0,
1100,0,0,15,0,0,15,1987,0,0,0,0,0,1,0,
1115,0,0,6,0,0,17,2975,0,0,1,1,0,1,0,1,9,0,0,
1134,0,0,6,0,0,21,2976,0,0,0,0,0,1,0,
1149,0,0,16,176,0,9,3041,0,0,2,2,0,1,0,1,9,0,0,1,3,0,0,
1172,0,0,16,0,0,13,3043,0,0,8,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,1,0,0,
2,9,0,0,2,9,0,0,2,4,0,0,
1219,0,0,16,0,0,15,3119,0,0,0,0,0,1,0,
1234,0,0,16,0,0,15,3130,0,0,0,0,0,1,0,
1249,0,0,17,159,0,6,3180,0,0,4,4,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1280,0,0,18,86,0,4,3238,0,0,2,1,0,1,0,2,3,0,0,1,9,0,0,
1303,0,0,19,167,0,6,3311,0,0,4,4,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1334,0,0,20,87,0,9,3374,0,0,1,1,0,1,0,1,9,0,0,
1353,0,0,20,0,0,13,3376,0,0,1,0,0,1,0,2,9,0,0,
1372,0,0,20,0,0,15,3393,0,0,0,0,0,1,0,
1387,0,0,20,0,0,15,3401,0,0,0,0,0,1,0,
1402,0,0,21,235,0,9,3650,0,0,1,1,0,1,0,1,9,0,0,
1421,0,0,21,0,0,13,3652,0,0,11,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,3,0,0,2,9,0,0,
2,4,0,0,2,3,0,0,2,3,0,0,2,3,0,0,2,3,0,0,2,3,0,0,
1480,0,0,21,0,0,15,3749,0,0,0,0,0,1,0,
1495,0,0,21,0,0,15,3761,0,0,0,0,0,1,0,
1510,0,0,22,86,0,9,3798,0,0,1,1,0,1,0,1,9,0,0,
1529,0,0,22,0,0,13,3800,0,0,3,0,0,1,0,2,1,0,0,2,9,0,0,2,9,0,0,
1556,0,0,22,0,0,15,3835,0,0,0,0,0,1,0,
1571,0,0,22,0,0,15,3845,0,0,0,0,0,1,0,
1586,0,0,23,188,0,4,3894,0,0,6,5,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,
1625,0,0,24,186,0,4,3908,0,0,6,5,0,1,0,2,1,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,0,
1,9,0,0,
1664,0,0,25,105,0,4,3973,0,0,3,2,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,
1691,0,0,26,513,0,6,4194,0,0,15,15,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,1,9,0,0,1,9,0,
0,1,1,0,0,1,9,0,0,1,9,0,0,1,4,0,0,1,4,0,0,1,9,0,0,1,1,0,0,1,9,0,0,1,9,0,0,1,9,
0,0,
1766,0,0,6,0,0,17,4416,0,0,1,1,0,1,0,1,9,0,0,
1785,0,0,6,0,0,21,4417,0,0,0,0,0,1,0,
1800,0,0,27,192,0,4,4462,0,0,3,2,0,1,0,2,3,0,0,1,9,0,0,1,9,0,0,
};
...
///////////////////////////////////////////////
//////////////////ParDefMisc///////////////////
int mf_DefMisc_GetValue(const char *csCode,
                          char *csValue)
{
                ...
                hash_t * hRec)
{
        ...
        /* EXEC SQL BEGIN DECLARE SECTION; */ 
                ...
                /* varchar         hv_sequence_type_name[MIG_PD_SEQUENCE_TYPE_NAME]; */ 
struct { unsigned short len; unsigned char arr[50]; } hv_sequence_type_name;


                /* varchar         v_category[MIG_PD_CATEGORY + 1]; */ 
...
struct { unsigned short len; unsigned char arr[4]; } v_reversal_txn_code;
                ...
                /* varchar         v_reversal_fee_txn_code[PD_TXN_CODE_LEN + 1]; */ 
struct { unsigned short len; unsigned char arr[4]; } v_reversal_fee_txn_code;


                short           ind_category = -1;
                short           ind_txn_code = -1;
                short           ind_reversal_txn_code = -1;
                short           ind_reversal_fee_txn_code = -1;
...
//DEBUGLOG(("GetCategory: sequence_type_name = [%.*s]\n",hv_sequence_type_name.len,hv_sequence_type_name.arr));
        ...
        /* EXEC SQL DECLARE c_cursor_getcategory CURSOR FOR
                SELECT pc_category, pc_txn_code, pc_reversal_txn_code, pc_reversal_fee_txn_code
                  FROM par_category
...

{
        ...
        do {
                ...
                INTO :v_category:ind_category,
                     ...
                     :v_reversal_fee_txn_code:ind_reversal_fee_txn_code; */ 

{
                ...
                sqlstm.sqhstv[3] = (unsigned char  *)&v_reversal_fee_txn_code;
                sqlstm.sqhstl[3] = (unsigned long )6;
                sqlstm.sqhsts[3] = (         int  )0;
                sqlstm.sqindv[3] = (         short *)&ind_reversal_fee_txn_code;
...
// reversal_fee_txn_code
                if (ind_reversal_fee_txn_code >= 0) {
                        v_reversal_fee_txn_code.arr[v_reversal_fee_txn_code.len] = '\0';
                        PutField_CString(hRec, "reversal_fee_txn_code", (const char*)v_reversal_fee_txn_code.arr);
//DEBUGLOG(("GetCategory reversal_fee_txn_code = [%s]\n",v_reversal_fee_txn_code.arr));
                }
...
//	int		iTestTWDAccount=PD_FALSE;

DEBUGLOG(("mig_funct:: mf_get_merch_txn_info:: START!\n"));

        rRecordSet = (recordset_t *)malloc(sizeof(recordset_t));
        hTxn = (hash_t *)malloc(sizeof(hash_t));

        if (GetField_CString(hMyHash, "txn_merch_nmb", &csMerchNmb)) {
DEBUGLOG(("mig_funct::mf_get_merch_txn_info:txn_merch_nmb [%s]\n", csMerchNmb));
        }
        else {
DEBUGLOG(("mig_funct::mf_get_merch_txn_info:txn_merch_nmb missing\n"));
                iRet = FAILURE;
        }

	/*
	if (strcmp(csMerchNmb, "50028") == 0) {
		GetField_CString(hMyHash, "ccy", &csTmp);
		if (strcmp(csTmp, "TWD") == 0) {
			iTestTWDAccount= PD_TRUE;
		}
	}
	*/
        ...
        if (iRet == SUCCESS) {
                if (mf_MerchProfile_GetMerchant(csMerchNmb, rRecordSet) != PD_OK) {
DEBUGLOG(("mig_funct::mf_get_merch_txn_info:call mf_MerchProfile_GetMerchant FAILED!\n"));
                } else {

                        hRec = RecordSet_GetFirst(rRecordSet);
                        while (hRec) {
                                if (GetField_CString(hRec, "service", &csService)) {
//DEBUGLOG(("mig_funct::mf_get_merch_txn_info: service [%s]!\n", csService));
                                        PutField_CString(hMyHash, "service", csService);
                                }

                                if (GetField_CString(hRec, "merchant_id", &csTmp)) {
//DEBUGLOG(("mig_funct::mf_get_merch_txn_info: merchant_id [%s]!\n", csTmp));
                                        PutField_CString(hMyHash, "merchant_id", csTmp);
                                }

                                if (GetField_CString(hRec, "client_id", &csTmp)) {
//DEBUGLOG(("mig_funct::mf_get_merch_txn_info: client_id [%s]!\n", csTmp));
                                        PutField_CString(hMyHash, "merchant_client_id", csTmp);
                                }

                                if (GetField_CString(hRec, "country", &csTmp)) {
//DEBUGLOG(("mig_funct::mf_get_merch_txn_info: country [%s]!\n", csTmp));
...
/*
	if (iTestTWDAccount == PD_TRUE) {
		PutField_CString(hMyHash, "service", "EC2");
		PutField_CString(hMyHash, "country", "TW");
	}
*/
	...
	// Payment method
        ...
        if (iRet == SUCCESS) {
                ...
                if (mf_ServicePayMethod_FindPayMethod(csService, rRecordSet) != PD_OK) {
DEBUGLOG(("mig_funct::mf_get_merch_txn_info:Call mf_ServicePayMethod_FindPayMethod FAILED!\n"));
                } else {
                        hRec = RecordSet_GetFirst(rRecordSet);
                        while (hRec) {
                                if (GetField_CString(hRec, "pay_method", &csTmp)) {
DEBUGLOG(("mig_funct::mf_get_merch_txn_info:pay_method [%s]!\n", csTmp));
...
DEBUGLOG(("mig_funct::mf_get_merch_txn_info: txn_nmb [%s]\n", csVNCRefNum));
                }
                else {
DEBUGLOG(("mig_funct::mf_get_merch_txn_info: txn_nmb not found!\n"));
                        iRet = FAILURE;
                }
        }
...
DEBUGLOG(("mig_funct::mf_get_merch_txn_info:mf_ParTxnData_ChkExist FAILED!\n"));
                        iRet = FAILURE;
                }
...
DEBUGLOG(("mig_funct::mf_get_merch_txn_info: Call mf_GetOrgTxnID!\n"));
                        iRet = mf_GetOrgTxnID(hMyHash, hTxn);

                        if (iRet == SUCCESS) {

                                if (GetField_CString(hTxn, "txn_id", &csTmp)) {
DEBUGLOG(("mig_funct::mf_get_merch_txn_info: org_txn_id [%s]!\n", csTmp));
...
DEBUGLOG(("mig_funct::mf_get_merch_txn_info: Return [%d]\n", iRet));
                ...
                recordset_t* myRec)
{
        ...
        /* EXEC SQL BEGIN DECLARE SECTION; */ 
                ...
                /* varchar         hv_merch_account_nmb[MIG_PD_MERCH_ACCOUNT_NMB_LEN]; */ 
...
//DEBUGLOG(("UpdateProcessTxnResult status [%s]\n", csStatus));
        ...
        if (mf_UpdateTxnDataStatus(hMyHash) == PD_OK) {
...
//DEBUGLOG(("UpdateStatus: Begin\n"));
        ...
        strcpy((char*)hv_dynstmt.arr,"update par_mig_txn_data set mtd_update_timestamp  = sysdate");
...
DEBUGLOG(("UpdateStatus:proc_status= [%s]\n",csTmp));
                ...
                strcat((char*)hv_dynstmt.arr, ",mtd_proc_status = '");
                strcat((char*)hv_dynstmt.arr, csTmp);
                strcat((char*)hv_dynstmt.arr, "'");
                hv_dynstmt.len = strlen((const char*)hv_dynstmt.arr);

		/* status timestamp */
		strcat((char*)hv_dynstmt.arr, ", mtd_status_timestamp = systimestamp");
		hv_dynstmt.len = strlen((const char*)hv_dynstmt.arr);
        ...
        strcat((char *)hv_dynstmt.arr, " WHERE mtd_txn_seq = ");
...
DEBUGLOG(("GetOrgTxnID vnc_ref_num [%s]\n", csVNCRefNum));
        ...
        if (mf_GetTxnHeaderByVNCRefNum(csVNCRefNum, hTxnHeader) == PD_OK) {
...
DEBUGLOG(("Update: Begin\n"));
        csBuf = (char*) malloc (128);
        //strcpy((char*)hv_dynstmt.arr,"update txn_header set th_update_timestamp  = sysdate");
        strcpy((char*)hv_dynstmt.arr,"update txn_header set th_update_timestamp = th_update_timestamp"); 
        hv_dynstmt.len = strlen((const char*)hv_dynstmt.arr);
...
int mf_ParPspClientMap_GetPspID(hash_t *hRec)
{
        ...
        /* EXEC SQL BEGIN DECLARE SECTION; */ 
                ...
                /* varchar hv_psp_type_cd[MIG_PD_PSP_TYPE_CD]; */ 
...
struct { unsigned short len; unsigned char arr[10]; } hv_psp_channel_code;
		...
		/* varchar	hv_default_channel_code [PD_PSP_CHANNEL_CODE_LEN]; */ 
struct { unsigned short len; unsigned char arr[10]; } hv_default_channel_code;
...
DEBUGLOG(("GetBankCode: ext_bank_code [%.*s]\n", hv_ext_bank_code.len, hv_ext_bank_code.arr));
	...
	if (GetField_CString(hRec, "psp_channel_code", &csTmp)) {
		...
		memcpy(hv_psp_channel_code.arr, csTmp, hv_psp_channel_code.len);
DEBUGLOG(("GetBankCode: psp_channel_code [%.*s]\n", hv_psp_channel_code.len, hv_psp_channel_code.arr));
	}

	hv_default_channel_code.len = strlen("DEF");
	memcpy(hv_default_channel_code.arr, "DEF", hv_default_channel_code.len);
	

        /* EXEC SQL DECLARE c_cursor_get_bank_code CURSOR FOR
                select bc_int_bank_code
		  from (select bc_int_bank_code
                          from par_int_bank_code_map
                          where bc_bank_name = :hv_ext_bank_code
                           and decode(bc_special_psp_channel, :hv_default_channel_code, :hv_psp_channel_code, bc_special_psp_channel) = :hv_psp_channel_code
                        order by decode(bc_special_psp_channel, :hv_default_channel_code, 9999, 1)
			)
		 where rownum = 1; */ 
...

{
        ...
        sqlstm.sqadto[0] = (unsigned short )0;
        sqlstm.sqtdso[0] = (unsigned short )0;
        sqlstm.sqhstv[1] = (unsigned char  *)&hv_default_channel_code;
        ...
        sqlstm.sqadto[1] = (unsigned short )0;
        sqlstm.sqtdso[1] = (unsigned short )0;
        sqlstm.sqhstv[2] = (unsigned char  *)&hv_psp_channel_code;
        ...
        sqlstm.sqadto[2] = (unsigned short )0;
        sqlstm.sqtdso[2] = (unsigned short )0;
        sqlstm.sqhstv[3] = (unsigned char  *)&hv_psp_channel_code;
        ...
        sqlstm.sqadto[3] = (unsigned short )0;
        sqlstm.sqtdso[3] = (unsigned short )0;
        sqlstm.sqhstv[4] = (unsigned char  *)&hv_default_channel_code;
...

{
                ...
                sqlstm.sqhstv[7] = (unsigned char  *)&v_request_amount;
                sqlstm.sqhstl[7] = (unsigned long )sizeof(double);
                sqlstm.sqhsts[7] = (         int  )0;
                sqlstm.sqindv[7] = (         short *)&ind_request_amount;
                sqlstm.sqinds[7] = (         int  )0;
                sqlstm.sqharm[7] = (unsigned long )0;
                sqlstm.sqadto[7] = (unsigned short )0;
                sqlstm.sqtdso[7] = (unsigned short )0;
                sqlstm.sqhstv[8] = (unsigned char  *)&v_request_ccy;
                sqlstm.sqhstl[8] = (unsigned long )6;
                sqlstm.sqhsts[8] = (         int  )0;
                sqlstm.sqindv[8] = (         short *)&ind_request_ccy;
                sqlstm.sqinds[8] = (         int  )0;
                sqlstm.sqharm[8] = (unsigned long )0;
                sqlstm.sqadto[8] = (unsigned short )0;
                sqlstm.sqtdso[8] = (unsigned short )0;
                sqlstm.sqhstv[9] = (unsigned char  *)&v_payout_ccy;
                sqlstm.sqhstl[9] = (unsigned long )6;
                sqlstm.sqhsts[9] = (         int  )0;
                sqlstm.sqindv[9] = (         short *)&ind_payout_ccy;
                sqlstm.sqinds[9] = (         int  )0;
                sqlstm.sqharm[9] = (unsigned long )0;
                sqlstm.sqadto[9] = (unsigned short )0;
                sqlstm.sqtdso[9] = (unsigned short )0;
                sqlstm.sqhstv[10] = (unsigned char  *)&v_merchant_fee_ccy;
                sqlstm.sqhstl[10] = (unsigned long )6;
                sqlstm.sqhsts[10] = (         int  )0;
                sqlstm.sqindv[10] = (         short *)&ind_merchant_fee_ccy;
                sqlstm.sqinds[10] = (         int  )0;
                sqlstm.sqharm[10] = (unsigned long )0;
                sqlstm.sqadto[10] = (unsigned short )0;
                sqlstm.sqtdso[10] = (unsigned short )0;
                sqlstm.sqhstv[11] = (unsigned char  *)&v_merchant_fee;
                sqlstm.sqhstl[11] = (unsigned long )sizeof(double);
                sqlstm.sqhsts[11] = (         int  )0;
                sqlstm.sqindv[11] = (         short *)&ind_merchant_fee;
                sqlstm.sqinds[11] = (         int  )0;
                sqlstm.sqharm[11] = (unsigned long )0;
                sqlstm.sqadto[11] = (unsigned short )0;
                sqlstm.sqtdso[11] = (unsigned short )0;
                sqlstm.sqhstv[12] = (unsigned char  *)&v_markup_ccy;
                sqlstm.sqhstl[12] = (unsigned long )6;
                sqlstm.sqhsts[12] = (         int  )0;
                sqlstm.sqindv[12] = (         short *)&ind_markup_ccy;
                sqlstm.sqinds[12] = (         int  )0;
                sqlstm.sqharm[12] = (unsigned long )0;
                sqlstm.sqadto[12] = (unsigned short )0;
                sqlstm.sqtdso[12] = (unsigned short )0;
                sqlstm.sqhstv[13] = (unsigned char  *)&v_markup_amt;
                sqlstm.sqhstl[13] = (unsigned long )sizeof(double);
                sqlstm.sqhsts[13] = (         int  )0;
                sqlstm.sqindv[13] = (         short *)&ind_markup_amt;
                ...
                sqlstm.sqhstv[17] = (unsigned char  *)&v_branch;
                sqlstm.sqhstl[17] = (unsigned long )103;
                sqlstm.sqhsts[17] = (         int  )0;
                sqlstm.sqindv[17] = (         short *)&ind_branch;
                sqlstm.sqinds[17] = (         int  )0;
                sqlstm.sqharm[17] = (unsigned long )0;
                sqlstm.sqadto[17] = (unsigned short )0;
                sqlstm.sqtdso[17] = (unsigned short )0;
                sqlstm.sqhstv[18] = (unsigned char  *)&v_account_id;
                sqlstm.sqhstl[18] = (unsigned long )28;
                sqlstm.sqhsts[18] = (         int  )0;
                sqlstm.sqindv[18] = (         short *)&ind_account_id;
                sqlstm.sqinds[18] = (         int  )0;
                sqlstm.sqharm[18] = (unsigned long )0;
                sqlstm.sqadto[18] = (unsigned short )0;
                sqlstm.sqtdso[18] = (unsigned short )0;
                sqlstm.sqhstv[19] = (unsigned char  *)&v_account_name;
                sqlstm.sqhstl[19] = (unsigned long )103;
                sqlstm.sqhsts[19] = (         int  )0;
                sqlstm.sqindv[19] = (         short *)&ind_account_name;
...
DEBUGLOG(("GetPayoutDetailByVncRefNum payout_amount = [%lf]\n",v_payout_amount));
        }
...
/* bank_name */
                if (ind_bank_name >= 0) {
                        v_bank_name.arr[v_bank_name.len]='\0';
                        PutField_CString(myHash,"stl_txn_bank_name",(const char*)v_bank_name.arr);
DEBUGLOG(("GetPayoutDetailByAuxVncRefNum bank_name = [%s]\n",v_bank_name.arr));
                }
...
/* bank_code */
                if (ind_bank_code >= 0) {
                        v_bank_code.arr[v_bank_code.len]='\0';
                        PutField_CString(myHash,"stl_txn_bank_code",(const char*)v_bank_code.arr);
DEBUGLOG(("GetPayoutDetailByAuxVncRefNum bank_code = [%s]\n",v_bank_code.arr));
                }
...
/* branch */
                if (ind_branch >= 0) {
                        v_branch.arr[v_branch.len]='\0';
                        PutField_CString(myHash,"stl_txn_branch",(const char*)v_branch.arr);
DEBUGLOG(("GetPayoutDetailByAuxVncRefNum branch= [%s]\n",v_branch.arr));
                }
...
/* account_id */
                if (ind_account_id >= 0) {
                        v_account_id.arr[v_account_id.len]='\0';
                        PutField_CString(myHash,"stl_txn_account_id",(const char*)v_account_id.arr);
DEBUGLOG(("GetPayoutDetailByAuxVncRefNum account_id = [%s]\n",v_account_id.arr));
                }
...
/* account_name */
                if (ind_account_name >= 0) {
                        v_account_name.arr[v_account_name.len]='\0';
                        PutField_CString(myHash,"stl_txn_account_name",(const char*)v_account_name.arr);
DEBUGLOG(("GetPayoutDetailByAuxVncRefNum account_name = [%s]\n",v_account_name.arr));
                }
...
DEBUGLOG(("format_data txn_code [%s]\n", csTmp));
	...
	if (GetField_CString(hMyHash, "post_data", &csTmp)) {
...
DEBUGLOG(("format_data local_tm_time [%s]\n", csTmp));
	...
	if (GetField_CString(hMyHash, "local_tm_date", &csLocalDate) &&
	    GetField_CString(hMyHash, "local_tm_time", &csLocalTime)) {
                ...
                PutField_CString(hRequest, "tm_date", csLocalDate);
                PutField_CString(hRequest, "tm_time", csLocalTime);
...
DEBUGLOG(("format_data approval_date [%s]\n", csTmp));
			...
			GetField_CString(hMyHash, "txn_datetimestamp", &csTmp);
                        PutField_CString(hContext, "approval_timestamp", csTmp);
DEBUGLOG(("format_data approval_timestamp [%s]\n", csTmp));
                }
        }
...
DEBUGLOG(("PayoutAddTxnLog:: internal_code = [%d]\n",iTmp));
                ...
                if (GetField_CString(hContext,"host_posting_date",&csTmp)) {
...
DEBUGLOG(("PayoutAddTxnLog:: create_datetime = [%s]\n",csTmp));
                        PutField_CString(hTxn,"create_datetime",csTmp);
		}
		if (GetField_CString(hContext, "update_datetime", &csTmp)) {
DEBUGLOG(("PayoutAddTxnLog:: update_datetime = [%s]\n",csTmp));
                        PutField_CString(hTxn,"update_datetime",csTmp);
		}

		if (GetField_CString(hContext, "remark", &csTmp)) {
DEBUGLOG(("PayoutAddTxnLog:: remark = [%s]\n",csTmp));
...
DEBUGLOG(("handle_payout_balance: fee missing\n"));
        ...
        if (iRet == SUCCESS) {
                if (migbo_UpdatePayoutAmount(hMyHash) == PD_OK) {
                        if (GetField_Double(hMyHash, "merchant_open_bal", &dTmp)) {
...
DEBUGLOG(("UpdateTxnLog:: new_txn_code = [%s]\n",csPtr));
		...
		if (GetField_CString(hContext, "update_datetime", &csPtr)) {
DEBUGLOG(("UpdateTxnLog:: update_datetime = [%s]\n",csPtr));
                        PutField_CString(hTxn,"update_datetime",csPtr);
		}
...
/* update txn header */
               ...
               // iRet = (unsigned long)(*DBObjPtr)(hTxn);
		iRet = ml_Txn_Header_Update(hTxn);
        }
        else
                iRet = PD_ERR;
...
/* txn_bank_name */
                if (GetField_CString(hContext,"txn_bank_name",&csPtr)) {
			PutField_CString(hTxn, "bank_name", csPtr);
DEBUGLOG(("UpdateTxnLog:: bank_name = [%s]\n",csPtr));
		}

/* txn_bank_code */
		if (GetField_CString(hContext, "txn_bank_code", &csPtr)) {
			PutField_CString(hTxn, "bank_code", csPtr);
DEBUGLOG(("UpdateTxnLog:: bank_code = [%s]\n",csPtr));
		}
/* txn_branch */
		if (GetField_CString(hContext, "txn_branch", &csPtr)) {
			PutField_CString(hTxn, "branch", csPtr);
DEBUGLOG(("UpdateTxnLog:: branch= [%s]\n",csPtr));
		}
/* txn_account_id */
		if (GetField_CString(hContext, "txn_account_id", &csPtr)) {
			PutField_CString(hTxn, "account_id", csPtr);
DEBUGLOG(("UpdateTxnLog:: account_id = [%s]\n",csPtr));
		}
/* txn_account_name */
		if (GetField_CString(hContext, "txn_account_name", &csPtr)) {
...
DEBUGLOG(("UpdateTxnLog:: account_name = [%s]\n",csPtr));
                ...
                //iRet = (unsigned long)(*DBObjPtr)(hTxn);
		iRet = ml_Txn_Detail_UpdateDetail(hTxn);
        }
		...
		if (iPayoutBalTransfer == PD_TRUE) {
			...
			if (GetField_Int(hMyHash, "payout_void_flag", &iPayoutVoidFlag)) {
				if (iPayoutVoidFlag == PD_FALSE) {
					if (migbo_AddPayoutBalTransferElement(hPayoutTxn) != PD_OK) {
						iRet = FAILURE;
					}
				}
			}
...
DEBUGLOG(("AddTxnAmtElement\n"));
	        if(migbo_AddTxnAmtElement(hTxn)!=PD_OK){
			iRet = FAILURE;
...
DEBUGLOG(("AddTxnFeeElements\n"));
                if(migbo_AddTxnFeeElements(hTxn)!=PD_OK){
                        iRet = FAILURE;
...
DEBUGLOG(("AddMarkupAmtElement\n"));
                        if(migbo_AddMarkupAmtElement(hTxn)!=PD_OK){
                                iRet = FAILURE;
...
DEBUGLOG(("UpdateVoidPOTxnStatus: Begin\n"));
        csBuf = (char*) malloc (128);
        strcpy((char*)hv_dynstmt.arr,"update par_mig_txn_data set ptd_update_timestamp  = sysdate");
        hv_dynstmt.len = strlen((const char*)hv_dynstmt.arr);
...
DEBUGLOG(("UpdateVoidPOTxnStatus: void_po_status = [%s]\n",csTmp));
                ...
                strcat((char*)hv_dynstmt.arr, ",mtd_po_psp_status = '");
                strcat((char*)hv_dynstmt.arr, csTmp);
                strcat((char*)hv_dynstmt.arr, "'");
                hv_dynstmt.len = strlen((const char*)hv_dynstmt.arr);
        }        sprintf(csBuf, "%d", iSortTxnSeq);
...
int	AddTxnSeqMap(const hash_t *hRls)
{
	char	*csTmp;
        ...
        /* EXEC SQL BEGIN DECLARE SECTION; */ 
                ...
                /* varchar         hv_order_id[MIG_ORDER_ID_LEN]; */ 
...
DEBUGLOG(("mf_merchant_getmerchanttxninfo() service_code = [%s]\n",csServiceCode));
        }
        else  {
DEBUGLOG(("mf_merchant_getmerchanttxninfo() service_code is missing!!!\n"));
ERRLOG("mig_funct::mf_merchant_getmerchanttxninfo() service_code is missing!!!\n");
                iRet = INT_ERR;
        }

        if (GetField_CString(hRequest,"merchant_id",&csMerchantId)) {
DEBUGLOG(("mf_merchant_getmerchanttxninfo() merchant_id = [%s]\n",csMerchantId));
        }
        else {
        ...
        if (iRet == PD_OK ) {
		if (mf_MerchDetail_GetMerchant(csMerchantId, rRecordSet) != PD_OK) {
                        iRet = INT_MERCHANT_ID_NOT_FOUND;
ERRLOG("mig_funct::mf_merchant_getmerchanttxninfo() Merchant Account [%s] not found\n",csMerchantId);
DEBUGLOG(("mf_merchant_getmerchanttxninfo() Merchant Account [%s] not found\n",csMerchantId));
                }
                else {
                        iRet = INT_MERCHANT_ID_NOT_FOUND;
                        hRec = RecordSet_GetFirst(rRecordSet);
...
DEBUGLOG(("mf_merchant_getmerchanttxninfo() GetMerchantDetail - disabled = [%d]\n",iTmp));
                                }
                                if(GetField_CString(hRec,"status",&csTmp)){
DEBUGLOG(("mf_merchant_getmerchanttxninfo() GetMerchantDetail - status = [%s]\n",csTmp));
                                }
...
DEBUGLOG(("mf_merchant_getmerchanttxninfo() GetMerchantDetail - merchant_name = [%s]\n",csTmp));
                                                }
                                                if (GetField_CString(hRec,"merchant_client_id",&csMerchantClientId)) {
DEBUGLOG(("mf_merchant_getmerchanttxninfo() GetMerchantDetail - merchant_client_id = [%s]\n",csMerchantClientId));
                                                        PutField_CString(hContext,"merchant_client_id",csMerchantClientId);
                                                }
                                                if (GetField_Double(hRec,"approximate_fee_rate",&dTmp)) {
//DEBUGLOG(("mf_merchant_getmerchanttxninfo() GetMerchantTxnInfo() GetMerchantDetail - approximate_fee_rate = [%lf]\n",dTmp));
                                                        PutField_Double(hContext,"approximate_fee_rate",dTmp);
                                                }
                                        }
                                        else{
ERRLOG("mig_funct::mf_merchant_getmerchanttxninfo() GetMerchantTxnInfo() Merchant Account [%s] not opened\n",csMerchantId);
                                                iRet = INT_ACCOUNT_DISABLED;
                                        }
                                }
                                else {
ERRLOG("mig_funct:: mf_merchant_getmerchanttxninfo GetMerchantTxnInfo() Merchant Account [%s] disabled\n",csMerchantId);
                                        iRet = INT_ACCOUNT_DISABLED;
                                }
        ...
        if(iRet == PD_OK){
                ...
                hash_init(hClient,0);
		if (mf_Clients_GetClients(csMerchantClientId, hClient) != PD_OK) {
                        iRet = INT_ERR;
ERRLOG("mig_funct:: mf_merchant_getmerchanttxninfo GetMerchantTxnInfo() Client ID for Account[%s] not found\n",csMerchantId);
DEBUGLOG(("mf_merchant_getmerchanttxninfo GetMerchantTxnInfo() Client ID Account[%s] not found\n",csMerchantId));
                }
                else{
                        if (GetField_CString(hClient,"status",&csTmp)) {
DEBUGLOG(("mf_merchant_getmerchanttxninfo ::GetMerchantTxnInfo() GetClients - status = [%s]\n",csTmp));
                                        if(strcmp(csTmp,PD_ACC_OPEN)){
ERRLOG("mig_funct::mf_merchant_getmerchanttxninfo() Client Account [%s] not opened\n",csMerchantClientId);
                                                iRet = INT_ACCOUNT_DISABLED;
                                        }
                        }
                }
        ...
        if(iRet == PD_OK){
                if (!GetField_CString(hRequest,"txn_ccy",&csTxnCcy)) {
                        iRet = INT_ERR;
ERRLOG("mig_funct::mf_merchant_getmerchanttxnInfo() Currency for Account is missing\n");
DEBUGLOG(("mig_funct::mf_merchant_getmerchanttxninfo()  Currency for Account is missing\n"));
                }
                else {
DEBUGLOG(("mig_funct::mf_merchant_getmerchanttxninfo() txn ccy = [%s]\n",csTxnCcy));
                }
                if (!GetField_CString(hRequest,"txn_country",&csTxnCountry)) {
                        iRet = INT_ERR;
ERRLOG("mig_funct::mf_merchant_getmerchanttxninfo() Txn Country for Account is missing\n");
DEBUGLOG(("mig_funct::getmerchanttxninfo() Txn Country for Account is missing\n"));
                }
                else {
DEBUGLOG(("mig_funct::getmerchanttxninfo() txn country = [%s]\n",csTxnCountry));
                }
                if (iRet == PD_OK) {
                        if (mf_MerchBalAcct_CheckMerchantBalAcct(csMerchantId,
                                                        csTxnCountry,
                                                        csTxnCcy,
                                                        csServiceCode,
                                                        hContext) != PD_FOUND) {
                                iRet = INT_INVALID_TXN;
ERRLOG("mig_funct::getmerchanttxninfo() Invalid txn acct [%d] [%s] [%s] [%s]\n",iRet,csMerchantId,csTxnCountry,csTxnCcy);
DEBUGLOG(("mig_funct::getmerchanttxninfo () txn acct  [%d] [%s] [%s] [%s]\n",iRet,csMerchantId,csTxnCountry,csTxnCcy));
                        }
                }
        }
...
DEBUGLOG(("mig_funct::getmerchanttxninfo() pay_method = [%s]\n",csPayMethod));
...
DEBUGLOG(("mig_funct::getmerchanttxninfo() call DBMerchantPayMethod:FindMerchantPayMethod [%s] [%s]\n", csMerchantId, csList[i]));
                                if (mf_MerchantPayMethod_FindMerchantPayMethod(csMerchantId, csList[i]) != PD_OK) {
DEBUGLOG(("mig_funct::getmerchanttxninfo() Unsupport Pay Method [%d] [%s] [%s]\n",iRet,csMerchantId,csList[i]));
                                }
                                else {
                                        iValidCnt ++;
DEBUGLOG(("mig_funct::getmerchanttxninfo() Support Pay Method [%d] [%s] [%s]\n",iRet,csMerchantId,csList[i]));
                                }
                        }
                        if(iValidCnt==0){
                                        iRet = INT_UNSUPPORTED_PAY_METHOD;
ERRLOG("mig_funct:: getmerchanttxninfo() All Pay Method UnSupported[%d] [%s]\n",iRet,csMerchantId);
                        }
                }
        }
...
int	mf_MerchDetail_GetMerchant(const char* csMerchantID,
                recordset_t* myRec)
{
        int iRet = 0;

        hash_t *myHash;
        /* EXEC SQL WHENEVER SQLERROR GOTO mf_getmerchant_error; */ 
...
DEBUGLOG(("mf_MerchDetail_GetMerchant merchant_id = [%.*s]\n",hv_merchant_id.len,hv_merchant_id.arr));

        /* EXEC SQL DECLARE c_cursor_mf_getmerchant CURSOR FOR
                select client_id,
                       name,
                       short_name,
                       disabled,
        ...
        /* EXEC SQL OPEN c_cursor_mf_getmerchant; */ 

{
        ...
        sqlstm.sqptdso = sqlstm.sqtdso;
        sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
        if (sqlca.sqlcode < 0) goto mf_getmerchant_error;
}


        do {
                /* EXEC SQL FETCH c_cursor_mf_getmerchant
                INTO
                        :v_client_id:ind_client_id,
                        :v_name:ind_name,
...
DEBUGLOG(("mf_MerchDetail_GetMerchant client_id = [%s]\n",v_client_id.arr));
                }
...
//DEBUGLOG(("mf_MerchDetail_GetMerchant merchant_name = [%s]\n",v_name.arr));
                }
...
//DEBUGLOG(("mf_MerchDetail_GetMerchant merchant_short_name = [%s]\n",v_short_name.arr));
                }

/* disabled */
                if (ind_disabled >= 0) {
                        PutField_Int(myHash,"disabled",v_disabled);
//DEBUGLOG(("mf_MerchDetail_GetMerchant disabled  = [%d]\n",v_disabled));
                }
...
//DEBUGLOG(("mf_MerchDetail_GetMerchant ignore_nack = [%d]\n",v_ignore_nack));
        ...
        /* EXEC SQL CLOSE c_cursor_mf_getmerchant; */ 
...
DEBUGLOG(("mf_MerchDetail_GetMerchant Normal Exit\n"));
        if(iRet==0) return  PD_OK;
        else    return iRet;

mf_getmerchant_error:
DEBUGLOG(("mf_getmerchant_error code %d\n", sqlca.sqlcode));
DEBUGLOG(("\n%.*s\n", sqlca.sqlerrm.sqlerrml, sqlca.sqlerrm.sqlerrmc));
        /* EXEC SQL WHENEVER SQLERROR CONTINUE; */ 
...
int mf_Clients_GetClients(const char* csClientId,
                hash_t* hRec)
{
        /* EXEC SQL WHENEVER SQLERROR GOTO mf_getclients_error; */ 
...
DEBUGLOG(("mf_Clients_GetClients client_id = [%d][%.*s]\n",hv_client_id.len,hv_client_id.len,hv_client_id.arr));

        /* EXEC SQL DECLARE c_cursor_mf_getclients CURSOR FOR
                select
                        business_type,
                        client_name,
                        status
        ...
        /* EXEC SQL OPEN c_cursor_mf_getclients; */ 

{
        ...
        sqlstm.sqptdso = sqlstm.sqtdso;
        sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
        if (sqlca.sqlcode < 0) goto mf_getclients_error;
}


        do {
                /* EXEC SQL FETCH c_cursor_mf_getclients
...
DEBUGLOG(("mf_Clients_GetClients found record\n"));

/* client name */
                if (ind_name >= 0) {
                        v_name.arr[v_name.len] = '\0';
                        PutField_CString(hRec,"client_name",(const char*)v_name.arr);
//DEBUGLOG(("mf_Clients_GetClients client_name = [%s]\n",v_name.arr));
                }

/* type */
                if (ind_type >= 0) {
                        PutField_Char(hRec,"business_type",v_type);
DEBUGLOG(("mf_Clients_GetClients type = [%c]\n",v_type));
                }
...
/* status */
                if (ind_status >= 0) {
                        v_status.arr[v_status.len] = '\0';
                        PutField_CString(hRec,"status",(const char*)v_status.arr);
//DEBUGLOG(("mf_Clients_GetClients status = [%s]\n",v_status.arr));
                }

        }
        while(PD_TRUE);

        /* EXEC SQL CLOSE c_cursor_mf_getclients; */ 
...
DEBUGLOG(("mf_Clients_GetClients Normal Exit\n"));
        return  PD_OK;

mf_getclients_error:
DEBUGLOG(("mf_getclients_error code %d\n", sqlca.sqlcode));
DEBUGLOG(("\n%.*s\n", sqlca.sqlerrm.sqlerrml, sqlca.sqlerrm.sqlerrmc));
                ...
                hash_t *hRec)
{
        ...
        /* EXEC SQL WHENEVER SQLERROR GOTO mf_check_error; */ 
...
struct { unsigned short len; unsigned char arr[2]; } hv_status;
        ...
        hv_merchant_id.len = strlen(csMerchantID);
        memcpy(hv_merchant_id.arr,csMerchantID,hv_merchant_id.len);
DEBUGLOG(("mf_MerchBalAcct_CheckMerchantBalAcct merchant_id = [%.*s]\n",hv_merchant_id.len,hv_merchant_id.arr));

        hv_country.len = strlen(csCountry);
        memcpy(hv_country.arr,csCountry,hv_country.len);
DEBUGLOG(("mf_MerchBalAcct_CheckMerchantBalAcct country = [%.*s]\n",hv_country.len,hv_country.arr));

        hv_ccy.len = strlen(csCcy);
        memcpy(hv_ccy.arr,csCcy,hv_ccy.len);
DEBUGLOG(("mf_MerchBalAcct_CheckMerchantBalAcct ccy = [%.*s]\n",hv_ccy.len,hv_ccy.arr));

        hv_service_code.len = strlen(csServiceCode);
        memcpy(hv_service_code.arr,csServiceCode,hv_service_code.len);
DEBUGLOG(("mf_MerchBalAcct_CheckMerchantBalAcct service_code = [%.*s]\n",hv_service_code.len,hv_service_code.arr));
...

{
        ...
        sqlstm.sqladtp = &sqladt;
        sqlstm.sqltdsp = &sqltds;
        sqlstm.stmt = "select nvl(count(*) ,0) into :b0  from merchant_bal_\
acct where (((((mb_merchant_id=:b1 and mb_country=:b2) and mb_ccy_id=:b3) and\
 mb_service_code=:b4) and mb_disabled=0) and mb_status=:b5)";
        sqlstm.iters = (unsigned int  )1;
        ...
        sqlstm.sqptdso = sqlstm.sqtdso;
        sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
        if (sqlca.sqlcode < 0) goto mf_check_error;
}
        ...
        if (v_cnt > 0){
                iRet = PD_FOUND;
DEBUGLOG(("mf_MerchBalAcct_CheckMerchantBalAcct  found! [%d]\n",v_cnt));
...

{
                ...
                sqlstm.sqladtp = &sqladt;
                sqlstm.sqltdsp = &sqltds;
                sqlstm.stmt = "select mb_txn_type into :b0:b1  from merchan\
t_bal_acct where (((((mb_merchant_id=:b2 and mb_country=:b3) and mb_ccy_id=:b\
4) and mb_service_code=:b5) and mb_disabled=0) and mb_status=:b6)";
                sqlstm.iters = (unsigned int  )1;
                ...
                if(ind_txn_type>=0){
//DEBUGLOG(("mf_MrechBalAcct_CheckMerchantBalAcct txn_type=[%c]\n",v_txn_type));
                        if((v_txn_type == PD_TYPE_ALL) || (v_txn_type == PD_TYPE_PAYOUT)){
                                PutField_Int(hRec,"allow_payout",PD_TRUE);
//DEBUGLOG(("mf_MerchBalAcct_CheckMerchantBalAcct allow_payout=[%d]\n",PD_TRUE));
                        }
                        else{
...
DEBUGLOG(("mf_MerchBalAcct_CheckMerchantBalAcct Not found! [%d]\n",v_cnt));
        }


DEBUGLOG(("mf_MerchBalAcct_CheckMerchantBalAcct Normal Exit [%d]\n",iRet));
        return iRet;

mf_check_error:
DEBUGLOG(("mf_check_error code %d\n", sqlca.sqlcode));
DEBUGLOG(("\n%.*s\n", sqlca.sqlerrm.sqlerrml, sqlca.sqlerrm.sqlerrmc));
        /* EXEC SQL WHENEVER SQLERROR CONTINUE; */ 
                        ...
                        const char* csPayMethod)
{
        ...
        /* EXEC SQL WHENEVER SQLERROR GOTO mf_find_error; */ 
...

{
        ...
        sqlstm.sqladtp = &sqladt;
        sqlstm.sqltdsp = &sqltds;
        sqlstm.stmt = "select pm_disabled into :b0:b1  from merchant_pay_me\
thod where (pm_merchant_id=:b2 and pm_pay_method=:b3)";
        sqlstm.iters = (unsigned int  )1;
        ...
        sqlstm.sqptdso = sqlstm.sqtdso;
        sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
        if (sqlca.sqlcode < 0) goto mf_find_error;
}



        if (ind_disabled >= 0) {
DEBUGLOG(("mf_MerchantPayMethod_FindMerchantPayMethod: pm_disabled = [%d]\n",v_disabled));
                if (v_disabled != PD_DISABLED) {
DEBUGLOG(("mf_MerchantPayMethod_FindMerchantPayMethod: return PD_OK [%d]\n", PD_OK));
                        return PD_OK;
                }
                else {
DEBUGLOG(("mf_MerchantPayMethod_FindMerchantPayMethod: return PD_ERR [%d]\n", PD_ERR));
                        return PD_ERR;
                }
        }
DEBUGLOG(("mf_MerchantPayMethod_FindMerchantPayMethod: [%s][%s] Pay Method not supported\n",csMerchantId,csPayMethod));

        return PD_ERR;
mf_find_error:
DEBUGLOG(("mf_find_error code %d\n", sqlca.sqlcode));
DEBUGLOG(("\n%.*s\n", sqlca.sqlerrm.sqlerrml, sqlca.sqlerrm.sqlerrmc));
    /* EXEC SQL WHENEVER SQLERROR CONTINUE; */ 
...
DEBUGLOG(("GetPSPRelatedInfo: GetPSPRelatedInfo [%s]\n", csPspTypeCode));

                if (mf_ParPspClientMap_GetPspID(hMyHash) == FOUND) {
...
DEBUGLOG(("GetPSPRelatedInfo: psp_channel_code [%s]\n", csTmp));
                        }
                }
                else {
DEBUGLOG(("GetPSPRelatedInfo: DBParPspClientMap.GetPspID FAIL!\n"));
        ...
        if ((GetField_CString(hMyHash, "psp_type_code", &csPspTypeCode)) &&
            (GetField_CString(hMyHash, "gate_id", &csGateID))) {
                ...
                if (mf_ParPspClientMap_GetBankCode(hMyHash) == FOUND) {
...
int mf_MerchantSettlementDetail_Add(const hash_t* hRls)
{
        ...
        /* EXEC SQL WHENEVER SQLERROR GOTO msd_add_error; */ 
...
DEBUGLOG(("Add:update_datetime = [%.*s]\n",hv_update_datetime.len,hv_update_datetime.arr));
        ...
        /* EXEC SQL EXECUTE
            BEGIN
                ...
                :hv_return_value := sp_par_merch_settle_dt_insert(
...

{
        ...
        sqlstm.sqladtp = &sqladt;
        sqlstm.sqltdsp = &sqltds;
        sqlstm.stmt = "begin :hv_return_value := sp_par_merch_settle_dt_ins\
ert ( :hv_txn_id:ind_txn_id , :hv_merchant_id:ind_merchant_id , :hv_country_i\
d:ind_country_id , :hv_service_code:ind_service_code , :hv_status:ind_status \
, :hv_request_ccy:ind_request_ccy , :hv_deliver_ccy:ind_deliver_ccy , :hv_req\
uest_amt:ind_request_amt , :hv_deliver_amt:ind_deliver_amt , :hv_remark:ind_r\
emark , :hv_type:ind_type , :hv_create_user:ind_create_user , :hv_create_date\
time:ind_create_datetime , :hv_update_datetime:ind_update_datetime ) ; END ;";
        sqlstm.iters = (unsigned int  )1;
        ...
        sqlstm.sqadto[6] = (unsigned short )0;
        sqlstm.sqtdso[6] = (unsigned short )0;
        sqlstm.sqhstv[7] = (unsigned char  *)&hv_deliver_ccy;
        sqlstm.sqhstl[7] = (unsigned long )5;
        sqlstm.sqhsts[7] = (         int  )0;
        sqlstm.sqindv[7] = (         short *)&ind_deliver_ccy;
        sqlstm.sqinds[7] = (         int  )0;
        sqlstm.sqharm[7] = (unsigned long )0;
        sqlstm.sqadto[7] = (unsigned short )0;
        sqlstm.sqtdso[7] = (unsigned short )0;
        sqlstm.sqhstv[8] = (unsigned char  *)&hv_request_amt;
        ...
        sqlstm.sqadto[8] = (unsigned short )0;
        sqlstm.sqtdso[8] = (unsigned short )0;
        sqlstm.sqhstv[9] = (unsigned char  *)&hv_deliver_amt;
        sqlstm.sqhstl[9] = (unsigned long )sizeof(double);
        sqlstm.sqhsts[9] = (         int  )0;
        sqlstm.sqindv[9] = (         short *)&ind_deliver_amt;
        sqlstm.sqinds[9] = (         int  )0;
        sqlstm.sqharm[9] = (unsigned long )0;
        sqlstm.sqadto[9] = (unsigned short )0;
        sqlstm.sqtdso[9] = (unsigned short )0;
        sqlstm.sqhstv[10] = (unsigned char  *)&hv_remark;
        sqlstm.sqhstl[10] = (unsigned long )257;
        sqlstm.sqhsts[10] = (         int  )0;
        sqlstm.sqindv[10] = (         short *)&ind_remark;
        sqlstm.sqinds[10] = (         int  )0;
        sqlstm.sqharm[10] = (unsigned long )0;
        sqlstm.sqadto[10] = (unsigned short )0;
        sqlstm.sqtdso[10] = (unsigned short )0;
        sqlstm.sqhstv[11] = (unsigned char  *)&hv_type;
        sqlstm.sqhstl[11] = (unsigned long )1;
        sqlstm.sqhsts[11] = (         int  )0;
        sqlstm.sqindv[11] = (         short *)&ind_type;
        sqlstm.sqinds[11] = (         int  )0;
        sqlstm.sqharm[11] = (unsigned long )0;
        sqlstm.sqadto[11] = (unsigned short )0;
        sqlstm.sqtdso[11] = (unsigned short )0;
        ...
        sqlstm.sqadto[12] = (unsigned short )0;
        sqlstm.sqtdso[12] = (unsigned short )0;
        sqlstm.sqhstv[13] = (unsigned char  *)&hv_create_datetime;
        sqlstm.sqhstl[13] = (unsigned long )17;
        sqlstm.sqhsts[13] = (         int  )0;
        sqlstm.sqindv[13] = (         short *)&ind_create_datetime;
        sqlstm.sqinds[13] = (         int  )0;
        sqlstm.sqharm[13] = (unsigned long )0;
        sqlstm.sqadto[13] = (unsigned short )0;
        sqlstm.sqtdso[13] = (unsigned short )0;
        sqlstm.sqhstv[14] = (unsigned char  *)&hv_update_datetime;
        sqlstm.sqhstl[14] = (unsigned long )17;
        sqlstm.sqhsts[14] = (         int  )0;
        sqlstm.sqindv[14] = (         short *)&ind_update_datetime;
        sqlstm.sqinds[14] = (         int  )0;
        sqlstm.sqharm[14] = (unsigned long )0;
        sqlstm.sqadto[14] = (unsigned short )0;
        sqlstm.sqtdso[14] = (unsigned short )0;
        ...
        sqlstm.sqptdso = sqlstm.sqtdso;
        sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
        if (sqlca.sqlcode < 0) goto msd_add_error;
}
...
int mf_MerchantSettlementDetail_Update(const hash_t* hRls)
{
        ...
        /* EXEC SQL WHENEVER SQLERROR GOTO msd_update_error; */ 
...
DEBUGLOG(("Update: Begin\n"));
        ...
        strcpy((char*)hv_dynstmt.arr,"update merchant_settlement_detail set "); 
        hv_dynstmt.len = strlen((const char*)hv_dynstmt.arr);
...
DEBUGLOG(("Update:update_datetime = [%s]\n",csTmp));
        strcat((char*)hv_dynstmt.arr, "sd_update_timestamp = to_date('");
        strcat((char*)hv_dynstmt.arr, csTmp);
...

{
        ...
        sqlstm.sqptdso = sqlstm.sqtdso;
        sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
        if (sqlca.sqlcode < 0) goto msd_update_error;
}
...
msd_update_error:
DEBUGLOG(("msd_update_error code %d\n", sqlca.sqlcode));
DEBUGLOG(("\n%.*s\n", sqlca.sqlerrm.sqlerrml, sqlca.sqlerrm.sqlerrmc));
        /* EXEC SQL WHENEVER SQLERROR CONTINUE; */ 
...
int     mf_ChkValidMigPeriod(const char *csMerchNmb, const char *csTxnDate)
{
        ...
        /* EXEC SQL WHENEVER SQLERROR GOTO chkvalidmigperiod_error; */ 
        ...
        /* EXEC SQL BEGIN DECLARE SECTION; */ 
                ...
                /* varchar         hv_merch_nmb[MIG_PD_MERCH_ACCOUNT_NMB_LEN]; */ 
struct { unsigned short len; unsigned char arr[50]; } hv_merch_nmb;
...
struct { unsigned short len; unsigned char arr[8]; } hv_txn_date;
        ...
        hv_merch_nmb.len = strlen(csMerchNmb);
        memcpy(hv_merch_nmb.arr, csMerchNmb, hv_merch_nmb.len);
//DEBUGLOG(("ChkValidMigPeriod csMerchNmb = [%.*s]\n",hv_merch_nmb.len, hv_merch_nmb.arr));

        hv_txn_date.len = strlen(csTxnDate);
        memcpy(hv_txn_date.arr, csTxnDate, hv_txn_date.len);
//DEBUGLOG(("ChkValidMigPeriod csTxnDate= [%.*s]\n",hv_txn_date.len, hv_txn_date.arr));

        /* EXEC SQL
                SELECT count(1)
                   INTO :v_no_of_record:ind_no_of_record
                   FROM par_def_merch_mig_period, par_def_merch_nmb_map
                  WHERE mn_merchant_acct_nmb = :hv_merch_nmb
                    and mn_mig_group = mp_mig_group
                    and :hv_txn_date between mp_start_date and mp_end_date; */ 

{
        ...
        sqlstm.sqladtp = &sqladt;
        sqlstm.sqltdsp = &sqltds;
        sqlstm.stmt = "select count(1) into :b0:b1  from par_def_merch_mig_\
period ,par_def_merch_nmb_map where ((mn_merchant_acct_nmb=:b2 and mn_mig_gro\
up=mp_mig_group) and :b3 between mp_start_date and mp_end_date)";
        sqlstm.iters = (unsigned int  )1;
        ...
        sqlstm.sqadto[0] = (unsigned short )0;
        sqlstm.sqtdso[0] = (unsigned short )0;
        sqlstm.sqhstv[1] = (unsigned char  *)&hv_merch_nmb;
        sqlstm.sqhstl[1] = (unsigned long )52;
        sqlstm.sqhsts[1] = (         int  )0;
        sqlstm.sqindv[1] = (         short *)0;
        sqlstm.sqinds[1] = (         int  )0;
        ...
        sqlstm.sqptdso = sqlstm.sqtdso;
        sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
        if (sqlca.sqlcode < 0) goto chkvalidmigperiod_error;
}
        ...
        if (ind_no_of_record >= 0) {
                if (v_no_of_record > 0) {
//DEBUGLOG(("ChkValidMigPeriod FOUND\n"));
                        iRet = PD_FOUND;
                }
        }

        if (iRet!= PD_FOUND) {
DEBUGLOG(("ChkValidMigPeriod NOT FOUND\n"));
        }

        return iRet;

chkvalidmigperiod_error:
DEBUGLOG(("chkvalidmigperiod_error code %d\n", sqlca.sqlcode));
DEBUGLOG(("\n%.*s\n", sqlca.sqlerrm.sqlerrml, sqlca.sqlerrm.sqlerrmc));
        /* EXEC SQL WHENEVER SQLERROR CONTINUE; */ 
