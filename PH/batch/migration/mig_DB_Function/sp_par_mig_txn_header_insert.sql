create or replace function sp_par_mig_txn_header_insert(
       ...
       in_create_datetime                         txn_header.th_transmission_datetime%type,
       in_update_datetime                         txn_header.th_transmission_datetime%type)
  RETURN NUMBER IS
begin
...
EXCEPTION
  WHEN OTHERS THEN
     RETURN 9;
end sp_par_mig_txn_header_insert;
/
