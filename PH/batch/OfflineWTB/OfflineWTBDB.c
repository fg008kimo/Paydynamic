...
static unsigned int sqlctx = 2463147;
...
extern void sqliem( unsigned char *, signed int * );
 ...
 static char *sq0001 = 
"select batch_id , merchant_id , txn_date from payout_header where status = \
:b0            ";

 static char *sq0003 = 
"select status , merchant_ref , country , identity_id , account_name , accou\
nt_num , bank_name , bank_code , branch , phone_num , province , city , amoun\
t , payout_currency , dest_currency , checksum from payout_record where merch\
ant_id = :b0 and batch_id = :b1            ";
...
{12,4130,871,0,0,
5,0,0,1,90,0,9,120,0,2049,1,1,0,1,0,1,1,0,0,
24,0,0,1,0,0,13,123,0,0,3,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,
51,0,0,1,0,0,15,333,0,0,0,0,0,1,0,
66,0,0,2,0,0,32,334,0,0,0,0,0,1,0,
81,0,0,3,272,0,9,430,0,2049,2,2,0,1,0,1,9,0,0,1,9,0,0,
104,0,0,3,0,0,13,432,0,0,16,0,0,1,0,2,1,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,
9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
2,9,0,0,
183,0,0,3,0,0,15,585,0,0,0,0,0,1,0,
198,0,0,3,0,0,15,591,0,0,0,0,0,1,0,
213,0,0,4,0,0,32,592,0,0,0,0,0,1,0,
};
