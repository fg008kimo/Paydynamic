...
Changed to hash_t*
Add Node Txn Code				   2015/06/18		   Cody Chan
*/
...
/* node_txn_code */
	if (GetField_CString(hRequest,"node_txn_code",&csPtr)){
DEBUGLOG(("BOMMSPhTxn:AddLog node_txn_code = [%s]\n",csPtr));
...
DEBUGLOG(("BOMMSPhTxn:AddLog txn_country = [%s]\n",csPtr));
