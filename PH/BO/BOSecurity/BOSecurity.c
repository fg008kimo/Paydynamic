...
-------------------------------                    ------------            --------------
Init Version                                       2010/09/29              [GOD]
ESky Support					   2011/01/11		   [GOD]
MD5 Support					   2011/04/13		   [GOD]
YeePay Support					   2011/10/19		   [GOD]
MMS Support					   2011/10/21		   [GOD]
51Epay Support					   2011/11/11		   [GOD]
AllinPay Support				   2012/02/15		   [GOD]
AllinPay INQ Support				   2012/05/15		   [GOD]
Add HNAPay and BaoFoo				   2014/07/16		   [MSN]
Add TenMobile					   2014/12/18		   [SWK]
Add ReaPay					   2015/03/11		   [GOD]
ReaPay INQ support				   2015/04/09		   [MSN]
Add EasyPay					   2015/05/28		   [MSN]
Add YeePayMobile				   2015/08/04		   [MSN]
Remove EasyPay					   2015/09/21		   [MSN]
Add YsePay					   2016/06/28		   [MSN]
Add HeePay					   2016/08/24		   [MSN]
Add ECPSS Mobile				   2016/09/30		   [WCS]
Add WeChatPay					   2016/12/01		   [WCS]
Add XJP						   2016/12/19		   [WCS]
Add Now2Pay					   2016/12/22		   [WCS]
Add EASYPAY-AIPWechat				   2017/01/11		   [WCS]
Change Unipaygo from MD5 to RSA (send to PSP)	   2017/01/19		   [WCS]
Modify  VerifyMac, GenerateMac for payout API 	   2017/03/13		   [SWK]
...
Add PayLink-Dinpay				   2017/10/31		   [WCS]
Add Cloud123Pay					   2017/11/07		   [WCS]
Add PayLink-Dinpay QR				   2017/11/16		   [WCS]
Add XJ-Ehk new API				   2017/11/28		   [WCS]
Add STAR-KKPay EC				   2017/12/08		   [WCS]
Add PayLink-RFPay EC				   2017/12/11		   [WCS]
Add TZ-CoalaPay EC				   2017/12/18		   [WCS]
Add STAR-KKPay QR				   2018/01/12		   [WCS]
Add STAR-KKPay VNET				   2018/01/23		   [WCS]
Add EASYPAY-OpenePay				   2018/01/25		   [WCS]
Add SHANFU-SFPay EC				   2018/02/06		   [WCS]
Add PayLink-HXPay VNET				   2018/02/09		   [WCS]
Add PayLink-HXPay QR				   2018/02/09		   [MSN]
Add PAYESCAPE-eEpaylinks VNET			   2018/02/13		   [MSN]
Add SAMOPAY-SMPay EC				   2018/02/13		   [WCS]
Add PayLink-RFPay QR				   2018/03/19		   [WCS]
Add SHANFU-Payease QR				   2018/03/22		   [WCS]
Add PayLink-RFPay VNET				   2018/03/28		   [WCS]
Add PayLink-BFBao VNET				   2018/04/11		   [WCS]
Add PayLink-BFBao QR				   2018/04/23		   [MSN]
Add GOLDENPAY-SandPay VNET			   2018/04/24		   [WCS]
Add C123Pay QR					   2018/04/24              [MSN]
Add GOLDENPAY-SandPay EC			   2018/04/27		   [WCS]
Add	ZPAY EC
	VerifySHA256Sign
Update	GenerateSHA256Sign			   2018/04/30              [MSN]
Add ESKYPAY QR					   2018/05/03              [MSN]
Add Now3Pay					   2018/05/10              [MSN]
Add PayLink-TTPay EC/VNet + QR			   2018/05/28              [MSN]
Add ZPAY QR					   2018/07/18		   [WCS]
Add PayLink-WellPay				   2018/08/13		   [WCS]
Add XJ-DBao VNET/EC				   2018/08/22		   [WCS]
Add PayLink-SwiftPay QR				   2018/09/18		   [WCS]
Add GOLDENPAY-XPay VNET				   2018/09/21		   [WCS]
Add TRUSTPAY-SandPay EC				   2018/10/02		   [WCS]
Add OUP-OpenePay EC				   2018/10/15		   [WCS]
Add VerifyAESMac and GenerateAESMac		   2018/11/19		   [MSN]
Add EASYPAY-DF QR				   2018/11/26		   [WCS]
Add XJ-DBao QR					   2018/12/14		   [WCS]
Add XJ-CH					   2019/01/22		   [WCS]
...
Add provider XPAY EC				   2019/07/17		   [WCS]
Add provider XPAY QR				   2019/07/19		   [WCS]
Add EASYPAY-HANDPAY VNET			   2019/09/05		   [WCS]
Add OUP-YLPay QR				   2019/12/18		   [WCS]
Add EASYPAY-ALIPAY VNET				   2020/09/11		   [WCS]
Add WPAY EC					   2020/09/28		   [WMC]
...
DEBUGLOG(("VerifyMD5Sign() sign             = [%s]\n",csOUT));
	csTmpBuf[0] = '\0';
	    ...
	    !strcmp(csPspChannel,PD_CHANNEL_HANDPAY_VNET) ||
...
DEBUGLOG(("BOSecurity::GenreatePspSign psp_channel_code = [%s]\n",csPspChannel));
	...
	if (iRet == PD_OK) {
		if (!strcmp(csPspChannel,PD_CHANNEL_LKPAY))
			...
			MsgObjPtr = CreateObj(MsgPtr,"UnqMsg","BuildAuthData");
		else if (!strcmp(csPspChannel,PD_CHANNEL_TRUSTPAY_QR))
			MsgObjPtr = CreateObj(MsgPtr,"TpqMsg","BuildAuthData");
		else if (!strcmp(csPspChannel,PD_CHANNEL_ZXPAY_EC))
			MsgObjPtr = CreateObj(MsgPtr,"XyeMsg","BuildAuthData");
		else if (!strcmp(csPspChannel,PD_CHANNEL_ZXPAY_QR))
			MsgObjPtr = CreateObj(MsgPtr,"XyqMsg","BuildAuthData");
		else if (!strcmp(csPspChannel,PD_CHANNEL_HANDPAY_VNET)) {
			char *csPspPassphrase;
			if (GetField_CString(hContext,"psp_passphrase",&csPspPassphrase)) {
				PutField_CString(hResponse,"psp_passphrase",csPspPassphrase);
			}
			MsgObjPtr = CreateObj(MsgPtr,"HdvMsg","BuildAuthData");
		}
		else if (!strcmp(csPspChannel,PD_CHANNEL_OUP_QR))
			MsgObjPtr = CreateObj(MsgPtr,"OuqMsg","BuildAuthData");
		else if (!strcmp(csPspChannel,PD_CHANNEL_ALIPAY_VNET))
			MsgObjPtr = CreateObj(MsgPtr,"ApvMsg","BuildAuthData");
		else if (!strcmp(csPspChannel,PD_CHANNEL_WPAY_EC))
                        MsgObjPtr = CreateObj(MsgPtr,"WpeMsg","BuildAuthData");
		else if (!strcmp(csPspChannel,PD_CHANNEL_WPAY_QR))
                        MsgObjPtr = CreateObj(MsgPtr,"WpqMsg","BuildAuthData");
//do nothing
		else {
...
DEBUGLOG(("BOSecurity::GeneratePspSign() psp_passphrase = [%s]\n",csPtr));
				...
				|| !strcmp(csPspChannel,PD_CHANNEL_UNIPAY_QR)
				) {
...
DEBUGLOG(("BOSecurity::GeneratePspSign() psp_passphrase = [%s]\n",csPtr));
				...
				|| !strcmp(csPspChannel,PD_CHANNEL_ZXPAY_EC)
				|| !strcmp(csPspChannel,PD_CHANNEL_ZXPAY_QR)
				|| !strcmp(csPspChannel,PD_CHANNEL_WPAY_EC)
...
ERRLOG("TWV Channel access Key is missing\n");
			...
			else if (!strcmp(csReturnPspChannel,PD_CHANNEL_TRUSTPAY_QR))
				MsgObjPtr = CreateObj(MsgPtr,"TpqMsg","BuildRspAuthData");
			else if (!strcmp(csReturnPspChannel,PD_CHANNEL_ZXPAY_EC))
				MsgObjPtr = CreateObj(MsgPtr,"XyeMsg","BuildRspAuthData");
			else if (!strcmp(csReturnPspChannel,PD_CHANNEL_ZXPAY_QR))
				MsgObjPtr = CreateObj(MsgPtr,"XyqMsg","BuildRspAuthData");
			else if (!strcmp(csReturnPspChannel,PD_CHANNEL_HANDPAY_VNET))
				MsgObjPtr = CreateObj(MsgPtr,"HdvMsg","BuildRspAuthData");
			else if (!strcmp(csReturnPspChannel,PD_CHANNEL_OUP_QR))
				MsgObjPtr = CreateObj(MsgPtr,"OuqMsg","BuildRspAuthData");
			else if (!strcmp(csReturnPspChannel,PD_CHANNEL_ALIPAY_VNET))
				MsgObjPtr = CreateObj(MsgPtr,"ApvMsg","BuildRspAuthData");
			else if (!strcmp(csReturnPspChannel,PD_CHANNEL_WPAY_EC))
                                MsgObjPtr = CreateObj(MsgPtr,"WpeMsg","BuildRspAuthData");
			else if (!strcmp(csReturnPspChannel,PD_CHANNEL_WPAY_QR))
                                MsgObjPtr = CreateObj(MsgPtr,"WpqMsg","BuildRspAuthData");
			else {
...
DEBUGLOG(("BOSecurity::VerifyPspSign BuildData = [%d]\n",PD_OK));
					   ...
					   || !strcmp(csReturnPspChannel,PD_CHANNEL_HANDPAY_VNET)
					   || !strcmp(csReturnPspChannel,PD_CHANNEL_ALIPAY_VNET)
					) {
					   ...
					   || !strcmp(csReturnPspChannel,PD_CHANNEL_GOLDENPAY_EC)
						...
						!strcmp(csReturnPspChannel,PD_CHANNEL_TRUSTPAY_QR) ||
						!strcmp(csReturnPspChannel,PD_CHANNEL_OUP_QR)
					) {
...
*/
						...
						|| !strcmp(csReturnPspChannel,PD_CHANNEL_ZXPAY_EC)
						|| !strcmp(csReturnPspChannel,PD_CHANNEL_ZXPAY_QR)
						|| !strcmp(csReturnPspChannel,PD_CHANNEL_WPAY_EC)
						|| !strcmp(csReturnPspChannel,PD_CHANNEL_WPAY_QR)
					) {
