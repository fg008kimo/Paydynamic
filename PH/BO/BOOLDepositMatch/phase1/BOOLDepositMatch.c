...
DEBUGLOG(("HandleDepositMatchPair::GetPairByMerchTxnId - cannot get stmt_txn_id\n"));
				...
				{
					case 'S':
						PutField_CString(hTmp, "removal_action", "AUTO_MATCH");
						break;
					case 'A':
						PutField_CString(hTmp, "removal_action", "ADM_MAN_MATCH");
						break;
					case 'M':
						PutField_CString(hTmp, "removal_action", "MERCH_MAN_MATCH");
						break;
					case 'R':
...
DEBUGLOG(("HandleDepositMatchPair::GetPairByStmtTxnId - merch_txn_id = [%s]\n", csPairMerchTxnId));
					...
					{
						case 'S':
							PutField_CString(hRec, "removal_action", "AUTO_MATCH");
							break;
						case 'A':
							PutField_CString(hRec, "removal_action", "ADM_MAN_MATCH");
							break;
						case 'M':
							PutField_CString(hRec, "removal_action", "MERCH_MAN_MATCH");
							break;
						case 'R':
